...
output <- "Seurat/MeA_IndependentAnalysis/MeA_IndependentRound1_"
...
Intact
Castrate.data <- read_count_output("Kallisto_Bus_Output/CastrateMeA/combined_counts_em/", name="output", tcc=FALSE)
Castrate <- CreateSeuratObject(counts = Castrate.data, project = "CastrateFemale", min.cells=3, min.features=500)
Castrate
