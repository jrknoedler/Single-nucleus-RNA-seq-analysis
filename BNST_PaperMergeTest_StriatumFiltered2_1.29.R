...
output <- "Seurat/BNST_IndependentAnalysis/BNST_Fullmerge_Test2_sexclude_malat1regress_30pcsres1.2Esrs1filtalt"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
...
mySeurat <- subset(mySeurat, idents=c("43","38","30"), invert=TRUE)
