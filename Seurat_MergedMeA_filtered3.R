...
output <- "Seurat/MeA_IndependentAnalysis/MeA_MergedFinal2_Filtered3_malatregressreview_res1.2"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
...
mySeurat <- readRDS("Seurat/MeA_IndependentAnalysis/MeA_MergedFinal2_Filtered2.rds")
