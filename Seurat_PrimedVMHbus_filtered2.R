#!/usr/bin/env Rscript
output <- "Seurat/PrimedVMH_Bus/PrimedVMH_Exploratory_filtered2"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
...
mySeurat <- readRDS("Seurat/PrimedVMH_Bus/PrimedVMH_Exploratory_filtered1.rds")
mySeurat <- subset(mySeurat, idents=c("11"), invert=TRUE)
