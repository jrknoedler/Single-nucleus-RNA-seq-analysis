...
output <- "Seurat/BNST_IndependentAnalysis/BNST_Fullmerge_Test_Striatumfiltered_res1_sexclude_malat1regress_take1res_20pcs"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
library(dplyr)
mySeurat <- readRDS("Seurat/BNST_IndependentAnalysis/BNST_Fullmerge_Test_malat1regress_sexclude.rds")
mySeurat <- subset(mySeurat, idents=c("24","32"), invert=TRUE)
