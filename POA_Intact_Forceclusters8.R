...
output <- "Seurat/POA_IndependentAnalysis/POA_IndependentFiltered7_30pcsredo_res1"
...
Intact <- readRDS("Seurat/POA_IndependentAnalysis/POA_IndependentFiltered6_30pcsredo_res1_Intact.rds")
Intact <- subset(Intact, idents=c("28"), invert=TRUE)
