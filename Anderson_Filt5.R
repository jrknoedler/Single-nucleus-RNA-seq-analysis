...
output <- "Seurat/VMH_Anderson/Anderson_NonneuronalFilt5"
...
mySeurat <- readRDS("Seurat/VMH_Anderson/Anderson_NonneuronalFilt4.rds")
mySeurat <- subset(mySeurat, idents=c("5","42","47"), invert=TRUE)
