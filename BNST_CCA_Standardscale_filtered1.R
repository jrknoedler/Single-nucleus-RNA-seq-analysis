output <- "Seurat/BNST_IndependentAnalysis/BNST_Fullmerge_Test_CCAtestallstandardscaleDEGenforce_filtered1"
...
BNST.comb <- readRDS("Seurat/BNST_IndependentAnalysis/BNST_Fullmerge_Test_CCAtestallstandardscale_DEGenforceCCAscaledata_DEGsonly.rds")
BNST.comb <- subset(BNST.comb, idents=c("6","42"), invert=TRUE) 
