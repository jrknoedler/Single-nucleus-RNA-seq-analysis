...
library(scales)
library(patchwork)
output <- "Seurat/POA_IndependentAnalysis/POA_Merged_tCTDEGs_JuneFinal_10pct_zscaledratiovertbreakscale_CCAversion"
memory.limit(size=64000)
mySeurat <- readRDS("Seurat/POA_IndependentAnalysis/POA_Fullmerge_Test_CCAtestallstandardscaleDEGenforced_filtered5CCAscaledata_DEGsonly.rds")
...
pdf(file=paste0(output, "NewCombinedplotbluescalevert.pdf"), height=12, width=2)
(pd /p2f/pg/  p1 / p2 / p3) 
dev.off()