...
library(ggplot2)
library(patchwork)
output <- "Seurat/VMH_IndependentAnalysis/VMH_Paper_UMAPheatMap_Junefinal_25pct"
...
MvPSDEGs <- read.csv("Seurat/VMH_IndependentAnalysis/VMH_Merged_Clusterfuck_JuneFinal_25pct_MvP_sDEGspercluster.csv", header=TRUE)
MvPSDEGs <- data.frame(MvPSDEGs)
head(MvPSDEGs)
MvUSDEGs <- read.csv("Seurat/VMH_IndependentAnalysis/VMH_Merged_Clusterfuck_JuneFinal_25pct_MvU_sDEGspercluster.csv", header=TRUE)
MvUSDEGs <- data.frame(MvUSDEGs)
PvUEDGs <- read.csv("Seurat/VMH_IndependentAnalysis/VMH_Merged_Clusterfuck_JuneFinal_25pct_PvU_sDEGspercluster.csv", header=TRUE)
