...
library(ggplot2)
library(patchwork)
output <- "Seurat/MeA_IndependentAnalysis/MeA_Paper_UMAPheatMap_25pct_grayscale"
...
MvPSDEGs <- read.csv("Seurat/MeA_IndependentAnalysis/MeA_Merged_Clusterfuck_June_25pct_MvP_sDEGspercluster.csv", header=TRUE)
MvPSDEGs <- data.frame(MvPSDEGs)
head(MvPSDEGs)
MvUSDEGs <- read.csv("Seurat/MeA_IndependentAnalysis/MeA_Merged_Clusterfuck_June_25pct_MvU_sDEGspercluster.csv", header=TRUE)
MvUSDEGs <- data.frame(MvUSDEGs)
PvUEDGs <- read.csv("Seurat/MeA_IndependentAnalysis/MeA_Merged_Clusterfuck_June_25pct_PvU_sDEGspercluster.csv", header=TRUE)
