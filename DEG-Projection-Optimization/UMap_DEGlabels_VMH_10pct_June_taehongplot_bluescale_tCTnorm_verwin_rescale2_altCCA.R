...
library(patchwork)
library(scales)
output <- "X:/Seurat/VMH_IndependentAnalysis/VMH_Merged_JuneFinal_10pct_CCAtest"
memory.limit(64000)
mySeurat <- readRDS("Documents/VMHCCAscaledata_sexcludeDEGenforcefiltered6res1.2.rds")
...
pdf(file=paste0(output, "NewCombinedplotbluescalevert.pdf"), height=21, width=4)
(pd /p2f/pg/  p1 / p2 / p3) 
dev.off()