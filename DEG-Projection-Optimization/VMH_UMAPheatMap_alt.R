...
MvPSDEGs <- read.csv("Seurat/VMH_IndependentAnalysis/VMH_Fullmerge_20pcs_0.1cutoff_1.5foldMvP_SDEGS_Per_Clusterpct.csv", header=TRUE)
MvPSDEGs <- data.frame(MvPSDEGs)
MvUSDEGs <- read.csv("Seurat/VMH_IndependentAnalysis/VMH_Fullmerge_20pcs_0.1cutoff_1.5foldMvU_SDEGS_Per_Clusterpct.csv", header=TRUE)
MvUSDEGs <- data.frame(MvUSDEGs)
PvUEDGs <- read.csv("Seurat/VMH_IndependentAnalysis/VMH_Fullmerge_20pcs_0.1cutoff_1.5foldPvU_SDEGS_Per_Clusterpct.csv", header=TRUE)
