...
library(ggplot2)
library(patchwork)
output <- "Seurat/POA_IndependentAnalysis/POA_Paper_UMAPheatMap_25pct_grayscale_June"
...
MvPSDEGs <- read.csv("Seurat/POA_IndependentAnalysis/POA_Merged_Clusterfuck_Juneredo_25pct_MvP_sDEGspercluster.csv", header=TRUE)
MvPSDEGs <- data.frame(MvPSDEGs)
head(MvPSDEGs)
MvUSDEGs <- read.csv("Seurat/POA_IndependentAnalysis/POA_Merged_Clusterfuck_Juneredo_25pct_MvU_sDEGspercluster.csv", header=TRUE)
MvUSDEGs <- data.frame(MvUSDEGs)
PvUEDGs <- read.csv("Seurat/POA_IndependentAnalysis/POA_Merged_Clusterfuck_Juneredo_25pct_PvU_sDEGspercluster.csv", header=TRUE)
