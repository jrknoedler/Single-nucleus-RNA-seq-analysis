...
output <- "Seurat/VMH_IndependentAnalysis/VMH_IndependentFiltered3_Primed_10pcs_res1"
...
Primed <- readRDS("Seurat/VMH_IndependentAnalysis/VMH_IndependentFiltered2_Primed_10pcs_res1_Primed.rds")
