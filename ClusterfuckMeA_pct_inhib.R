...
output <- "Seurat/MeA_IndependentAnalysis/MeA_Merged_Clusterfuck_Marchredo_25pct_inhib"
mySeurat <- readRDS("Seurat/MeA_IndependentAnalysis/MeA_CCAfiltered1_res1.2marredo_esr1filt.rds")

mySeurat <- subset(mySeurat, idents=c("0","3","8","12","13","14","16","17","20","21","22","28","30","31","32","33","5","9","25"), invert=TRUE)
