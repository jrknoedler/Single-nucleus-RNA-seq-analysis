...
output <- "Seurat/MeA_IndependentAnalysis/MeA_MergedFinal_Filtered2alt"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
...
mySeurat <- readRDS("Seurat/MeA_IndependentAnalysis/MeA_MergedFinal_Filteredalt.rds")
mySeurat <- subset(mySeurat, idents=c("0","8","37"), invert=TRUE)
