...
output <- "Seurat/PregVMH_Exploratory/PregVMH_Filtered7"
...
mySeurat <- readRDS("Seurat/PregVMH_Exploratory/PregVMH_Filtered6.rds")
mySeurat <- subset(mySeurat, idents=c("1"), invert=TRUE)
