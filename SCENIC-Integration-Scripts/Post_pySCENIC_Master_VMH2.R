...
regoutput <- "RegulonsCompiled/VMH/Sexmarkersperclust/SemarkerRegulonOverlap"
...
files <- list.files(path="RegulonsCompiled/VMH/Sexmarkersperclust/", pattern="*.csv", full.names=TRUE, include.dirs=FALSE, recursive=FALSE)
...
files2 <- list.files(path="Seurat/VMH_IndependentAnalysis/Paper_DraftAnalysis/RegressDegome/MvP/", pattern="*sDEGpadjust.csv", full.names=TRUE, include.dirs=FALSE, recursive=FALSE)
...
files3 <- list.files(path="Seurat/VMH_IndependentAnalysis/Paper_DraftAnalysis/RegressDegome/MvU/", pattern="*sDEGpadjust.csv", full.names=TRUE, include.dirs=FALSE, recursive=FALSE)
...
files4 <- list.files(path="Seurat/VMH_IndependentAnalysis/Paper_DraftAnalysis/RegressDegome/PvU/", pattern="*sDEGpadjust.csv", full.names=TRUE, include.dirs=FALSE, recursive=FALSE)
...
#Sexmarkers <- read.table("RegulonsCompiled/VMH/DEGMarkers.txt")
#Sexmarkers <- unlist(Sexmarkers)
#Sexmarkers <- unique(Sexmarkers)
#Sexmarkers <- as.matrix(Sexmarkers)

#ClustDEGs <- read.table("RegulonsCompiled/VMH/ClusterSigDEGs.txt")
...
Degulators <- read.table("RegulonsCompiled/VMH/AllDegulators.txt")
