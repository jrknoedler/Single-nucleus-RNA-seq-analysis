...
output <- "C:/Users/Joe/OneDrive - Stanford/Pregnancy_papers/New_Regulons/Pos_Only/"
...
loom <- open_loom("X:/Joe_Sherlock_Backup3/Joe_Sherlock_Backup/pySCENIC_Singularity/PseudobulkGRN/GRN_Output/auc_mtx_filtered_2NES_onlyPos_Pseudobulkregulons.loom")
