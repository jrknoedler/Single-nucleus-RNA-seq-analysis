...
pdf(file=paste0(output, "Arx_VlnTargets.pdf"), width=20, height=10)
VlnPlot(mySeurat, features=c("Arx","Calb1"), ncol=1, pt.size=0, idents=c("14","3","24","17","22"), split.by="Hormone", cols=c("light blue","pink","light green"))
dev.off()
