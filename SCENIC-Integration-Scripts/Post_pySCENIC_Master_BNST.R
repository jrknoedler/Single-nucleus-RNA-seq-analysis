...
regoutput <- "RegulonsCompiled/BNST/Sexmarkersperclust/SemarkerRegulonOverlap"
...
pyScenicLoomFile <- file.path("pySCENIC_Singularity/BNST_DefaultNES_Final/auc_mtx_filtered.loom")
...
files <- list.files(path="RegulonsCompiled/BNST/Sexmarkersperclust/", pattern="*.csv", full.names=TRUE, include.dirs=FALSE, recursive=FALSE)
...
files2 <- list.files(path="Seurat/BNST_IndependentAnalysis/Paper_DraftAnalysis/RegressDegome/MvP/", pattern="*sDEGpadjust.csv", full.names=TRUE, include.dirs=FALSE, recursive=FALSE)
...
files3 <- list.files(path="Seurat/BNST_IndependentAnalysis/Paper_DraftAnalysis/RegressDegome/MvU/", pattern="*sDEGpadjust.csv", full.names=TRUE, include.dirs=FALSE, recursive=FALSE)
...
files4 <- list.files(path="Seurat/BNST_IndependentAnalysis/Paper_DraftAnalysis/RegressDegome/PvU/", pattern="*sDEGpadjust.csv", full.names=TRUE, include.dirs=FALSE, recursive=FALSE)
...
Sexmarkers <- read.table("RegulonsCompiled/BNST/DEGMarkers.txt")
Sexmarkers <- unlist(Sexmarkers)
Sexmarkers <- unique(Sexmarkers)
Sexmarkers <- as.matrix(Sexmarkers)

ClustDEGs <- read.table("RegulonsCompiled/BNST/ClusterSigDEGs.txt")
...
regulonsauc_text <- read.csv("pySCENIC_Singularity/BNST_DefaultNES_Final/auc_mtx_filtered.csv", header=TRUE, check.names=FALSE)
...
Degulons <- read.table("RegulonsCompiled/BNST/BNST_SCENICDegulons.txt")
...
Negulons <- read.table("RegulonsCompiled/BNST/BNST_Negulons.txt")
...
Posulons <- read.table("RegulonsCompiled/BNST/BNST_Posulons.txt")
