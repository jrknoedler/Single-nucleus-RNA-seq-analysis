...
output <- "Seurat/Pregnancy_Full_Dataset_Analysis/Regulons_Pseudobulk/2NES/"
...
loom <- open_loom("pySCENIC_Singularity/PseudobulkGRN/GRN_Output/auc_mtx_filtered_2NES_Pseudobulkregulons.loom")
...
try({
    ...
    regfolder <- "Seurat/Pregnancy_Full_Dataset_Analysis/Regulons_Pseudobulk/2NES/Regulons/"
