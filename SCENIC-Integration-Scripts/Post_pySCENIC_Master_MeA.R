...
Degulators <- read.table("RegulonsCompiled/MeA/Degulators.txt")
...
Negulons <- read.table("RegulonsCompiled/MeA/Negulons.txt")
...
Posulons <- read.table("RegulonsCompiled/MeA/Posulons.txt")
