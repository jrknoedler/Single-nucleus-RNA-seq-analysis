...
output <- "Seurat/Pregnancy_Full_Dataset_Analysis/Regulons_1stpass/Regulons_DefaultNES_PosNeg"
...
try({
loom <- open_loom(paste0(i,"/auc_mtx_filtered_v2.loom"))
...
for (i in regs){
    ...
    regfolder <- "Seurat/Pregnancy_Full_Dataset_Analysis/Regulons_1stpass/Regulons_1stPass_MarchFinal/"
