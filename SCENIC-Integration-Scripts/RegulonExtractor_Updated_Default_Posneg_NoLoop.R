...
output <- "Seurat/Pregnancy_Full_Dataset_Analysis/Regulons_Pseudobulk/Regulons_DefaultNES_PosNeg"
...
loom <- open_loom("pySCENIC_Singularity/PseudobulkGRN/GRN_Output/auc_mtx_filtered_LowNES_Pseudobulkregulons.loom")
...
try({
    ...
    regfolder <- "Seurat/Pregnancy_Full_Dataset_Analysis/Regulons_Pseudobulk/Regulons_May/"
