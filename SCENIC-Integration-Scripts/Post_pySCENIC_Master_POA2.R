...
regoutput <- "RegulonsCompiled/POA/Sexmarkersperclust/SemarkerRegulonOverlap"
...
files <- list.files(path="RegulonsCompiled/POA/Sexmarkersperclust/", pattern="*.csv", full.names=TRUE, include.dirs=FALSE, recursive=FALSE)
...
files2 <- list.files(path="Seurat/POA_IndependentAnalysis/Paper_DraftAnalysis/RegressDegome/MvP/", pattern="*sDEGpadjust.csv", full.names=TRUE, include.dirs=FALSE, recursive=FALSE)
...
files3 <- list.files(path="Seurat/POA_IndependentAnalysis/Paper_DraftAnalysis/RegressDegome/MvU/", pattern="*sDEGpadjust.csv", full.names=TRUE, include.dirs=FALSE, recursive=FALSE)
...
files4 <- list.files(path="Seurat/POA_IndependentAnalysis/Paper_DraftAnalysis/RegressDegome/PvU/", pattern="*sDEGpadjust.csv", full.names=TRUE, include.dirs=FALSE, recursive=FALSE)
...
#Sexmarkers <- read.table("RegulonsCompiled/POA/DEGMarkers.txt")
#Sexmarkers <- unlist(Sexmarkers)
#Sexmarkers <- unique(Sexmarkers)
#Sexmarkers <- as.matrix(Sexmarkers)

#ClustDEGs <- read.table("RegulonsCompiled/POA/ClusterSigDEGs.txt")
...
regulonsauc_text <- read.csv("pySCENIC_Singularity/POA_DefaultNES_Final/auc_mtx_filtered.csv", header=TRUE, check.names=FALSE)
...
Degulators <- read.table("RegulonsCompiled/POA/AllDegulators.txt")
...
Negulons <- read.table("RegulonsCompiled/POA/POA_Negulons.txt")
...
Posulons <- read.table("RegulonsCompiled/POA/POA_Posulons.txt")
