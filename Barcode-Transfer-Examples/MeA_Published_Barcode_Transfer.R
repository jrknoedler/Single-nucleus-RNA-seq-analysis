...
#sampleID <- "PregPOA"
output <- "Seurat/MeA_Barcode_Transfer/MeA_Barcode_Lift_Naive"
...
mySeurat <- merge(x=Pregnant, y=c(PrimedSeurat,UnprimedSeurat,MaleSeurat), add.cell.ids=c("Pregnant","Primed","Unprimed","Male"), project="MeA_Preg_Merged")
