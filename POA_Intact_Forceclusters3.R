...
output <- "Seurat/POA_IndependentAnalysis/POA_IndependentFiltered1_15pcs_filtered2"
...
Intact <- readRDS("Seurat/POA_IndependentAnalysis/POA_IndependentFiltered1_20pcs_Intact.rds")
Intact <- subset(Intact, idents=c("29","26","25","23"), invert=TRUE)
...
dev.off()
Intact <- BuildClusterTree(Intact, dims=1:15)
