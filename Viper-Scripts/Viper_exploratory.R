...
saveRDS(final_out, file="ViperOut/POA/InhibitoryEsr.rds")
df_obj <- summary(final_out, mrs=100)
df_obj
write.csv(df_obj, file="ViperOut/POA/Inhibitory_MvFregulonstest.csv")
pdf(file=paste0(output,"mrsplot1.pdf"))
