...
regdata <- file("ARACHNE/MacoskoLiger/expressionmtx.txt")
adjfile <- file("ARACHNE/MacoskoLiger/network_3col.txt")
...
saveRDS(final_out, file="ViperOut/BNST/AllMalevAllPrimed_Macosckoreg.rds")
df_obj <- summary(final_out, mrs=100)
df_obj
write.csv(df_obj, file="ViperOut/BNST/AllMalevAlPrimedMacoskoregtop100.csv")
pdf(file="ViperOut/BNST/AllMalevAllPrimedMacoskoregmrsplot1.pdf"))
