...
output <- "Seurat/MeA_IndependentAnalysis/Paper_DraftAnalysis/DEGome1/MvU/MvU_DEGome1.5fold"
...
mySeurat <- readRDS("Seurat/MeA_IndependentAnalysis/MeAMerged_filtered2_Paperanalysis.rds")
