...
output <- "Seurat/POA_IndependentAnalysis/POA_Fullmerge_Kiss1opt_Filtered2_30pcs_res1.2"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
library(dplyr)
mySeurat <- readRDS("Seurat/POA_IndependentAnalysis/POA_Fullmerge_Kiss1opt_Filtered1.rds")
mySeurat<- subset(mySeurat, idents=c("28"), invert=TRUE)
