...
output <- "Seurat/MeA_IndependentAnalysis/MeA_IndependentFiltered1_"
...
Intact <- readRDS("Seurat/MeA_IndependentAnalysis/MeA_IndependentRound1__Intact.rds")
Primed <- readRDS("Seurat/MeA_IndependentAnalysis/MeA_IndependentRound1__Primed.rds")
Castrate <- readRDS("Seurat/MeA_IndependentAnalysis/MeA_IndependentRound1__Castrate.rds")
Unprimed <- readRDS("Seurat/UnprimedMeA_Exploratory/UnprimedMeA_1000cutoff_filtered3.rds")
Intact <- subset(Intact, idents=c("13"), invert=TRUE)
...
dev.off()
saveRDS(Primed, file=(paste0(output, "_Castrate.rds")))
...
#Retransform, cluster and save sample4
...
dev.off()
saveRDS(Primed, file=(paste0(output, "_Unprimed.rds")))
