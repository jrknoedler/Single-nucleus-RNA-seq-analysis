...
output <- "Seurat/POA_IndependentAnalysis/POA_IndependentFiltered1_15pcs_filtered3_res1"
...
Intact <- readRDS("Seurat/POA_IndependentAnalysis/POA_IndependentFiltered1_15pcs_filtered2_Intact.rds")
Intact <- subset(Intact, idents=c("1"), invert=TRUE)
