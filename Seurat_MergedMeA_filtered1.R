...
output <- "Seurat/MeA_IndependentAnalysis/MeA_MergedFinal2_Filtered1"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
...
mySeurat <- readRDS("Seurat/MeA_IndependentAnalysis/MeA_Fullmerge_Finalv2_.rds")
mySeurat <- subset(mySeurat, idents=c("30","44"), invert=TRUE)
