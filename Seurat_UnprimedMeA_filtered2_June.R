...
output <- "Seurat/UnprimedMeA_Exploratory/UnprimedMeA_emptyDrops_June_Filtered2"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
...
mySeurat <- readRDS("Seurat/UnprimedMeA_Exploratory/UnprimedMeA_emptyDrops_June_Filtered1.rds")
mySeurat <- subset(mySeurat, idents=c("16","9"), invert=TRUE)
