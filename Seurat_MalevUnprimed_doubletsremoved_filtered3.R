...
output <- "Seurat/POA_MalevUnprimedMerged_Exploratory/MaleUnprimed_doubletsremoved_filtered3"
...
mySeurat <- readRDS("Seurat/POA_MalevUnprimedMerged_Exploratory/MaleUnprimed_doubletsremoved_filtered2.rds")
mySeurat
filteredSeurat <- subset(mySeurat, idents=c("34"), invert=TRUE)
