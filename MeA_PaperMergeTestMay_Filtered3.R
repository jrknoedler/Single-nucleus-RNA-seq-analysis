...
output <- "Seurat/MeA_IndependentAnalysis/MeA_JuneMerge_filtered3alt"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
library(dplyr)
mySeurat <- readRDS("Seurat/MeA_IndependentAnalysis/MeA_JuneMerge_filtered2.rds")
mySeurat <- subset(mySeurat, idents=c("0","5","26","11","29"), invert=TRUE)
