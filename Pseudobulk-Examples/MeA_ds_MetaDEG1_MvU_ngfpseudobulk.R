...
output <- "Seurat/MeA_IndependentAnalysis/Paper_DraftAnalysis/RegressDegome_LessFilt/metaDEGs/MvU_AllDEGs_"
...
mySeurat <- subset(mySeurat, idents=c("4","9","25"))
...
write.csv(restargeted, file=paste0(output,"_ngf_pseudobulksDEGpadjust.csv"))
