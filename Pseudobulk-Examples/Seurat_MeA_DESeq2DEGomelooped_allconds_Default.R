...
output <- "Seurat/MeA_IndependentAnalysis/Paper_DraftAnalysis/RegressDegome/Default/MvP/MvP_DEGome1.5fold_reclusteredfinal"
mvuoutput <- "Seurat/MeA_IndependentAnalysis/Paper_DraftAnalysis/RegressDegome/Default/MvU/MvU_DEGome1.5fold_reclusteredfinal"
pvuoutput <- "Seurat/MeA_IndependentAnalysis/Paper_DraftAnalysis/RegressDegome/Default/PvU/PvU_DEGome1.5fold_reclusteredfinal"
baseoutput <- "Seurat/MeA_IndependentAnalysis/Paper_DraftAnalysis/RegressDegome/Default/"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
