...
output <- "Seurat/VMH_IndependentAnalysis/Paper_DraftAnalysis/RegressDegome/MetaDEGs/MvP_AllDEGs_"
...
mySeurat <- subset(mySeurat, idents=c("1","2","3","4","6","8","9","10","14","16","17","19","20","21","23","24","25","26"))
...
write.csv(restargeted, file=paste0(output,"_excit_pseudobulksDEGpadjust.csv"))
