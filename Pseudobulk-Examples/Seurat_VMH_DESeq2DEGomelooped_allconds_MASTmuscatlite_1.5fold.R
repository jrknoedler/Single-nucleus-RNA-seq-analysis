...
output <- "Seurat/VMH_IndependentAnalysis/Paper_DraftAnalysis/RegressDegome/MAST_muscatelit2/MvP/MvP_DEGome1.5fold_reclusteredfinal_1.5fold"
mvuoutput <- "Seurat/VMH_IndependentAnalysis/Paper_DraftAnalysis/RegressDegome/MAST_muscatelit2/MvU/MvU_DEGome1.5fold_reclusteredfinal_1.5fold"
pvuoutput <- "Seurat/VMH_IndependentAnalysis/Paper_DraftAnalysis/RegressDegome/MAST_muscatelit2/PvU/PvU_DEGome1.5fold_reclusteredfinal_1.5fold"
baseoutput <- "Seurat/VMH_IndependentAnalysis/Paper_DraftAnalysis/RegressDegome/MAST_muscatelit2/"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
