...
output <- "Seurat/VMH_IndependentAnalysis/Paper_DraftAnalysis/RegressDegome/MetaDEGs/MvU_AllDEGs_"
...
write.csv(restargeted, file=paste0(output,"_exit_pseudobulksDEGpadjust.csv"))
