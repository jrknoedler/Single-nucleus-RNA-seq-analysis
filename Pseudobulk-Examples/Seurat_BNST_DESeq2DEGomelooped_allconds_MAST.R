...
output <- "Seurat/BNST_IndependentAnalysis/Paper_DraftAnalysis/Reclustered_DEGome/MAST/MvP/MvP_DEGome1.5fold_reclusteredfinal"
mvuoutput <- "Seurat/BNST_IndependentAnalysis/Paper_DraftAnalysis/Reclustered_DEGome/MAST/MvU/MvU_DEGome1.5fold_reclusteredfinal"
pvuoutput <- "Seurat/BNST_IndependentAnalysis/Paper_DraftAnalysis/Reclustered_DEGome/MAST/PvU/PvU_DEGome1.5fold_reclusteredfinal"
baseoutput <- "Seurat/BNST_IndependentAnalysis/Paper_DraftAnalysis/Reclustered_DEGome/MAST"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
