...
output <- "Seurat/POA_IndependentAnalysis/Paper_DraftAnalysis/RegressDegome/MAST/MvP/MvP_DEGome1.5fold_reclusteredfinal"
mvuoutput <- "Seurat/POA_IndependentAnalysis/Paper_DraftAnalysis/RegressDegome/MAST/MvU/MvU_DEGome1.5fold_reclusteredfinal"
pvuoutput <- "Seurat/POA_IndependentAnalysis/Paper_DraftAnalysis/RegressDegome/MAST/PvU/PvU_DEGome1.5fold_reclusteredfinal"
baseoutput <- "Seurat/POA_IndependentAnalysis/Paper_DraftAnalysis/RegressDegome/MAST"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
