...
pregvpoutput <- "Seurat/MeA_Barcode_Transfer/Cluster_DEGs/MAST_noFilter/Preg_v_Primed/PregvPrimed_DEGome_"
pregvuoutput <- "Seurat/MeA_Barcode_Transfer/Cluster_DEGs/MAST_noFilter/Preg_v_Unprimed/PregvUnprimed_DEGome_"
...
mySeurat <- readRDS("Seurat/MeA_Barcode_Transfer/MeA_Barcode_Lift_SCT.rds")
...
genelist <- read.table("Genelists/PregnancyDEGs/UpdatedPregDEGs/MeA_PregvFr_All1.5.txt", header=FALSE)
...
genelist <- read.table("Genelists/PregnancyDEGs/UpdatedPregDEGs/MeA_PregvFnr_All1.5.txt", header=FALSE)
genelist <- unlist(genelist)
dim(x=mySeurat)
genes.10x <- (x=rownames(x=mySeurat))
unlist(genes.10x)
