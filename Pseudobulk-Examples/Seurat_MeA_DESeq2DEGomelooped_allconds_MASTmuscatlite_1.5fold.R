...
output <- "Seurat/MeA_IndependentAnalysis/Paper_DraftAnalysis/RegressDegome/MAST_muscatelite/MvP/MvP_DEGome1.5fold_reclusteredfinal_1.5"
mvuoutput <- "Seurat/MeA_IndependentAnalysis/Paper_DraftAnalysis/RegressDegome/MAST_muscatelite/MvU/MvU_DEGome1.5fold_reclusteredfinal_1.5"
pvuoutput <- "Seurat/MeA_IndependentAnalysis/Paper_DraftAnalysis/RegressDegome/MAST_muscatelite/PvU/PvU_DEGome1.5fold_reclusteredfinal_1.5"
baseoutput <- "Seurat/MeA_IndependentAnalysis/Paper_DraftAnalysis/RegressDegome/MAST_muscatelite/"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
