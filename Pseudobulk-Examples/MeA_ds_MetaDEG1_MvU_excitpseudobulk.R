...
output <- "Seurat/MeA_IndependentAnalysis/Paper_DraftAnalysis/RegressDegome_LessFilt/metaDEGs/MvU_AllDEGs_2000floor"
...
dsSeurat <- subset(dsSeurat, nCount_RNA > 2000)
