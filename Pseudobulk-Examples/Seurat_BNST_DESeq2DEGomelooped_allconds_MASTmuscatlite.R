...
output <- "Seurat/BNST_IndependentAnalysis/Paper_DraftAnalysis/MAST_muscatelite/MvP/MvP_DEGome1.5fold_reclusteredfinal"
mvuoutput <- "Seurat/BNST_IndependentAnalysis/Paper_DraftAnalysis/MAST_muscatelite/MvU/MvU_DEGome1.5fold_reclusteredfinal"
pvuoutput <- "Seurat/BNST_IndependentAnalysis/Paper_DraftAnalysis/MAST_muscatelite/PvU/PvU_DEGome1.5fold_reclusteredfinal"
