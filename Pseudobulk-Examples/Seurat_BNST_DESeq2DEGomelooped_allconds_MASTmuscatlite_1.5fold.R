...
output <- "Seurat/BNST_IndependentAnalysis/Paper_DraftAnalysis/MAST_muscatelite/MvP/MvP_DEGome1.5fold_reclusteredfinal_1.5fccutoff"
mvuoutput <- "Seurat/BNST_IndependentAnalysis/Paper_DraftAnalysis/MAST_muscatelite/MvU/MvU_DEGome1.5fold_reclusteredfinal_1.5fccutoff"
pvuoutput <- "Seurat/BNST_IndependentAnalysis/Paper_DraftAnalysis/MAST_muscatelite/PvU/PvU_DEGome1.5fold_reclusteredfinal_1.5fccutoff"
baseoutput <- "Seurat/BNST_IndependentAnalysis/Paper_DraftAnalysis/MAST_muscatelite/"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
