...
output <- "Seurat/POA_IndependentAnalysis/Paper_DraftAnalysis/RegressDegome/MvU_Excit/MvUExcit_DEGome1.5fold"
...
mySeurat <- subset(mySeurat, idents=c("1","3","4","5","6","10","11","12","13","14","17","19","20","21","23","24","25","26","27","29","31","32","33","34","35"), invert=TRUE)
inhib <- c("0","2","7","8","9","15","16","18","22","30","35","36","37","38")
