...
pregvpoutput <- "Seurat/BNST_Barcode_Transfer/Cluster_DEGs/MAST_1stpass/Preg_v_Primed/PregvPrimed_DEGome_"
pregvuoutput <- "Seurat/BNST_Barcode_Transfer/Cluster_DEGs/MAST_1stpass/Preg_v_Unprimed/PregvUnprimed_DEGome_"
...
sex.dimorphism <- FindMarkers(dsSeurat, assay="RNA", ident.1 = ident1, ident.2=ident2, min.cells.group=0, logfc.threshold=0, min.pct=0, only.pos=FALSE, features=filtered.PregvPrimed, verbose=TRUE)
...
sex.dimorphism <- FindMarkers(dsSeurat, assay="RNA", ident.1 = ident1, ident.2=ident2, min.cells.group=0, logfc.threshold=0, min.pct=0, only.pos=FALSE,features=filtered.PregvUnprimed, verbose=TRUE)
