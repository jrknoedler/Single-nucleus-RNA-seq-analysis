...
output <- "Seurat/MeA_IndependentAnalysis/Paper_DraftAnalysis/RegressDegome_LessFilt/MvU_inhib/MvU_DEGome1.5fold"
...
mySeurat <- subset(mySeurat, idents=c("0","3","4","9","25","8","12","13","14","16","17","20","21","22","28","30","31","32","33"),invert=TRUE)
excit <- c("1","2","5","6","7","10","11","15","18","19","23","24","26","27","29","34")
