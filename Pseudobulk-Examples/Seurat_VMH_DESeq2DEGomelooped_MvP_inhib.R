...
output <- "Seurat/VMH_IndependentAnalysis/Paper_DraftAnalysis/RegressDegome/MvP_inhib/MvP_DEGome1.5fold"
...
mySeurat <- subset(mySeurat, idents=c("1","2","3","4","6","8","9","10","14","16","17","19","20","21","23","24","25","26"), invert=TRUE)
excit <- c("0","5","7","11","12","13","15","18","22","27")
