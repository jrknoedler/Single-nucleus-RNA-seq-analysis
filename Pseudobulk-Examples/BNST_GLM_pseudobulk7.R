...
output <- "X:/Seurat/BNST_IndependentAnalysis/GLM_MetaDEGslocalsevenreps"
...
dim(Maledata.df)
subgroup <- rep(1:7, ceiling(nrow(Maledata.df)/7))
subgroup
dim(subgroup)
...
dim(Pseudobulk2)
dim(Pseudobulk3)
MalePseudoreps <- cbind(Pseudobulk1, Pseudobulk2, Pseudobulk3, Pseudobulk4, Pseudobulk5, Pseudobulk6, Pseudobulk7)
head(MalePseudoreps)
...
dim(Femaledata.df)
subgroupf <- rep(1:7, ceiling(nrow(Femaledata.df)/7))
subgroupf
dim(subgroupf)
...
dim(Pseudobulk2f)
dim(Pseudobulk3f)
FemalePseudoreps <- cbind(Pseudobulk1f, Pseudobulk2f, Pseudobulk3f, Pseudobulk4f, Pseudobulk5f, Pseudobulk6f, Pseudobulk7f)
...
subgroupu <- rep(1:7, ceiling(nrow(Unprimeddata.df)/7))
...
UnprimedPseudoreps <- cbind(Pseudobulk1u, Pseudobulk2u, Pseudobulk3u, Pseudobulk4u, Pseudobulk5u, Pseudobulk6u, Pseudobulk7u)
...
sampleTable <- data.frame(condition=factor(c(rep(cond1, 7), rep(cond2, 7), rep(cond3,7))))
...
restargeted$padj <- p.adjust(restargeted$pvalue, method="BH")
write.csv(restargeted, file=paste0(output,"_pseudobulksDEGpadjust.csv"))