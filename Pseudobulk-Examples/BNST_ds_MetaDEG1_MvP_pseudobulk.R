...
output <- "Seurat/BNST_IndependentAnalysis/Paper_DraftAnalysis/RegressDegome/MetaDEGs/MvP_AllDEGs_20kds"
...
datas <- SampleUMI(data, max.umi=20000, upsample=FALSE, verbose=TRUE)
datar <- round(datas)
