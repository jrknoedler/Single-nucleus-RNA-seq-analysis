...
output <- "Seurat/VMH_IndependentAnalysis/Paper_DraftAnalysis/RegressDegome/MAST_muscatelite/MvP/MvP_DEGome1.5fold_reclusteredfinal"
mvuoutput <- "Seurat/VMH_IndependentAnalysis/Paper_DraftAnalysis/RegressDegome/MAST_muscatelite/MvU/MvU_DEGome1.5fold_reclusteredfinal"
pvuoutput <- "Seurat/VMH_IndependentAnalysis/Paper_DraftAnalysis/RegressDegome/MAST_muscatelite/PvU/PvU_DEGome1.5fold_reclusteredfinal"
baseoutput <- "Seurat/VMH_IndependentAnalysis/Paper_DraftAnalysis/RegressDegome/MAST_muscatelite/"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
