...
Primed$sex <- "Primed"
Male$sex <- "Male" 
Primed <- subset(Primed, idents=c("14"))
Male <- subset(Male, idents=c("12"))
...
write.csv(markers, file="Seurat/MeA_IndependentAnalysis/MeA_Sfta_res1_40pcs_MvP_SDEGsdefault.csv")