output <- "Seurat/BNST_IndependentAnalysis/BNST_Fullmerge_Test_CCAtestallstandardscale_filtered3_res1"
...
BNST.comb <- readRDS("Seurat/BNST_IndependentAnalysis/BNST_Fullmerge_Test_CCAtestallstandardscale_filtered2CCAscaledata.rds")
BNST.comb <- subset(BNST.comb, idents=c("36"), invert=TRUE) 


DefaultAssay(BNST.comb) <- "integrated"
BNST.comb <- ScaleData(BNST.comb)
...
BNST.comb <- FindClusters(BNST.comb, resolution=1)
