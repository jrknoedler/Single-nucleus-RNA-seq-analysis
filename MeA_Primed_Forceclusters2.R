...
output <- "Seurat/MeA_IndependentAnalysis/MeA_IndependentFiltered2_Primed_40pcs_Res1"
...
Intact <- readRDS("Seurat/MeA_IndependentAnalysis/MeA_IndependentFiltered1__Primed.rds")
Intact <- subset(Intact, idents=c("20"), invert=TRUE)
