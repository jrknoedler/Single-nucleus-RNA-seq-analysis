output <- "Seurat/VMH_PrimedvMale_AparnaNorm/VMH_origregress_dropdimorphic_highres"
...
hvg.final
mySeurat <- ScaleData(mySeurat, vars.to.regress="orig.ident", features=hvg.final)
