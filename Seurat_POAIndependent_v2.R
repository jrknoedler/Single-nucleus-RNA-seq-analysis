...
output <- "Seurat/POA_IndependentAnalysis/POA_Prepaperrecluster_2"
...
Primed <- readRDS("Seurat/POA_IndependentAnalysis/POA_Primed_Kiss1opt_500.rds")
Intact <- readRDS("Seurat/POA_IndependentAnalysis/POA_Intact_Kiss1opt_500_Intact.rds")
Unprimed <- readRDS("Seurat/POA_IndependentAnalysis/POA_Unprimed_Kiss1opt_500.rds")
...
Unprimed <- FindClusters(Unprimed, resolution=1.2)
