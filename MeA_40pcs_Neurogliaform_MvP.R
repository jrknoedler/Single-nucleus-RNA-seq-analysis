...
Primed$sex <- "Primed"
Male$sex <- "Male" 
Primed <- subset(Primed, idents=c("3"))
Male <- subset(Male, idents=c("4","8"))
...
write.csv(markers, file="Seurat/MeA_IndependentAnalysis/MeA_Slc1a3_res1_40pcs_MvP_SDEGsMAST.csv")