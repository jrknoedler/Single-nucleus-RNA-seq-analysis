...
output <- "Seurat/MeA_IndependentAnalysis/MeA_MergedFinal2_Filtered7_malatregressreview_UMIfilter_res1.2"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
...
mySeurat <- readRDS("Seurat/MeA_IndependentAnalysis/MeA_MergedFinal2_Filtered6_malatregressreview_UMIfilter_res1.2.rds")
mySeurat <- subset(mySeurat, idents=c("13","23"), invert=TRUE)
