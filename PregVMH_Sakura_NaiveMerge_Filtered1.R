...
output <- "Seurat/Sakura_IntegrationTests/Naive_Integration_Fixed/VMH/IntegratedVMH_Naive_Filtered1"
...
mySeurat <- readRDS("Seurat/Sakura_IntegrationTests/Naive_Integration_Fixed/VMH/VMH_Naive_Integration_PC30_Res12_Fixed.rds")
