...
output <- "Seurat/BNST_IndependentAnalysis/BNST_Fullmerge_Test_Esr1filtered_striatumfiltered_sexclude_malat1regress_30pcsres1.2"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
library(dplyr)
mySeurat <- readRDS("Seurat/BNST_IndependentAnalysis/BNST_Fullmerge_Test_Esr1filtered_res1_sexclude_malat1regress_30pcsres1.2.rds")
mySeurat <- subset(mySeurat, idents=c("34","26"), invert=TRUE)
