...
Primed$sex <- "Primed"
Male$sex <- "Male" 
Primed <- subset(Primed, idents=c("5","13","23","20","19","12","6"))
Male <- subset(Male, idents=c("5","1","3","9","13","18","4","16","14"))
...
write.csv(markers, file="Seurat/BNST_IndependentAnalysis/BNST_Cyp19plusmatech_MvP_SDEGs.csv")