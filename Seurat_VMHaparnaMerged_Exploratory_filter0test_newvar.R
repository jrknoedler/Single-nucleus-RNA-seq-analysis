...
output <- "Seurat/VMH_PrimedvMale_AparnaNorm/VMH_MalevPrimed_aparnanorm_filter0test_newvar"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
...
Sex.integrated <- FindVariableFeatures(Sex.integrated, selection.method="vst", nfeatures=2000)
