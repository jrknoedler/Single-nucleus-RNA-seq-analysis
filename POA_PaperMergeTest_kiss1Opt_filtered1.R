...
output <- "Seurat/POA_IndependentAnalysis/POA_Fullmerge_Kiss1opt_Filtered1"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
library(dplyr)
mySeurat <- readRDS("Seurat/POA_IndependentAnalysis/POA_Fullmerge_Kiss1opt.rds")
mySeurat<- subset(mySeurat, idents=c("39","38","33","24","23"), invert=TRUE)
...
dev.off()
pdf(paste0(output,"_Esr1Vln_hormonelabel.pdf"), width=14)
