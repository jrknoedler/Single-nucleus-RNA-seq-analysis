...
library(reticulate)
library(ggplot2)
Esr1BNST.data <- Read10X(data.dir = "MaleBNST_Esr1_10x_Pilot_K2excludedsubset")
Esr1BNST <- CreateSeuratObject(counts = Esr1BNST.data, project ="MaleBNST", min.cells=3, min.features=200)
Esr1BNST <- subset(Esr1BNST, subset =  nCount_RNA < 28000)
...
pdf(file="Seurat/MaleEsr1_Sctransformexploratory/Seurat_Genesvdepth_k1.pdf")
...
dev.off()
pdf("Seurat/MaleEsr1_Sctransformexploratory/Seurat_MaleEsr1BNST_SctransformUMAP_k1.pdf")
DimPlot(Esr1BNST, label=TRUE)
dev.off()
cluster.markers <- FindAllMarkers(Esr1BNST)
write.csv(cluster.markers, file="Seurat/MaleEsr1_Sctransformexploratory/MaleEsr1BNST_clusters_k1.csv")
pdf("Seurat/MaleEsr1_Sctransformexploratory/Esr1_Cyp19a1_Pappa_violin_k1.pdf")
VlnPlot(Esr1BNST, features = c("Esr1","Cyp19a1","Pappa"))
dev.off()
pdf("Seurat/MaleEsr1_Sctransformexploratory/Esr1_Cyp19a1_Pappa_featureplot_k1.pdf")
FeaturePlot(Esr1BNST, features =c("Esr1","Cyp19a1","Pappa"))
dev.off()
pdf("Seurat/MaleEsr1_Sctransformexploratory/Esr1_Cyp19a1_Pappa_Ridgeplot_k1.pdf")
RidgePlot(Esr1BNST, features=c("Esr1","Cyp19a1","Pappa"))
dev.off()
pdf("Seurat/MaleEsr1_Sctransformexploratory/Esr1_Cyp19a1_Pappa_Dotplot_k1.pdf")
...
pdf("Seurat/MaleEsr1_Sctransformexploratory/Clusterheatmap_k1.pdf")
