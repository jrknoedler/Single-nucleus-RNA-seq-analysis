...
output <- "Seurat/VMH_MalevPrimedMerged_Exploratory/VMH_MalevPrimed_Exploratory_filtered1"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
...
Sex.integrated <- readRDS("Seurat/VMH_MalevPrimedMerged_Exploratory/VMH_MalevPrimed_Exploratory.rds")
Sex.integrated <- subset(Sex.integrated, idents=c("24","30"), invert=TRUE)
