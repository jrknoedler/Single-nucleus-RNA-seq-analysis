...
output <- "Seurat/UnprimedMeA_Exploratory/UnprimedMeA_emptyDrops_filtered1v3_30pcs_lowfdr_finalredo"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
...
mySeurat <- subset(mySeurat, idents=c("0","3","7","10","16","20","21","22","23"), invert=TRUE)
