...
output <- "Seurat/VMH_IndependentAnalysis/VMH_IndependentFiltered2_Unprimed_10pcs_res1"
...
Primed <- readRDS("Seurat/VMH_IndependentAnalysis/VMH_IndependentFiltered1_Unprimed_10pcs_res1_Primed.rds")
Primed <- subset(Primed, idents=c("0","12","13"), invert=TRUE)
