...
output <- "Seurat/VMH_IndependentAnalysis/VMHMerged_arcfinalfilter_sexclude_malat1regress_res1_20pcs_arcfiltered"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
...
mySeurat <- subset(mySeurat, idents=c("34","21","18","17","8","9"), invert=TRUE)
