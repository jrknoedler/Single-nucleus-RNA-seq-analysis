output <- "Seurat/POA_IndependentAnalysis/POA_Fullmerge_Test_CCAtestallstandardscaleDEGenforced_filtered1"
...
POA.comb <- readRDS("Seurat/POA_IndependentAnalysis/POA_Fullmerge_Test_CCAtestallstandardscale_CCAscaledata_DEGsonly.rds")
POA.comb <- subset(POA.comb, idents=c("22","28"), invert=TRUE) 
