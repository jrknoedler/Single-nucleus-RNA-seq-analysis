...
output <- "Seurat/MeA_Hong/Hong_JRK_Integrated_firstpass"
library(Seurat)
#library(cowplot)
#library(reticulate)
#library(ggplot2)
...
snEsr1 <- readRDS("Seurat/MeA_IndependentAnalysis/MeA_CCAfiltered1_res1.2marredo_esr1filt_33filt2_1.2_30pcs.rds")
macosko <- readRDS("Seurat/MeA_Hong/Hong_Filtered2.rds")
