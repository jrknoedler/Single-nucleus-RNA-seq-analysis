...
output <- "Seurat/MeA_IndependentAnalysis/MeA_CCAfiltered1_res1.2marredo_esr1filt"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
...
mySeurat <- readRDS("Seurat/MeA_IndependentAnalysis/MeA_Fullmerge_redo_CCA.rds")
DefaultAssay(mySeurat) <- "integrated"
mySeurat <- subset(mySeurat, idents=c("36","32","26","15"), invert=TRUE)
