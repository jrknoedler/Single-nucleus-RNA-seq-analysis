...
output <- "Seurat/MeA_Barcode_Transfer/MeA_Barcode_Lift_Filtered1"
...
mySeurat <- readRDS("Seurat/MeA_Barcode_Transfer/MeA_Barcode_Lift_Naive.rds")
DefaultAssay(mySeurat) <- "SCT"
mySeurat <- subset(mySeurat, idents=c("0","1","33","35"), invert=TRUE)
