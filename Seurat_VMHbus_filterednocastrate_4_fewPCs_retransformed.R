...
mySeurat <- readRDS("Seurat/VMH_BusMergeTest/VMH_BusMergeTest_nocastrate_filtered3_10pcs_res0.5_restransformed.rds")
mySeurat <- subset(mySeurat, idents=c("14"), invert=TRUE)
