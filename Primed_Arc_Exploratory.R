...
sampleID <- "PregPOA"
output <- "Seurat/Primed_Arcuate_Exploratory/Primed_Arcuate_1stPass_AdjustedParams"
...
library(dplyr)
library(Matrix)
Seurat.data <- read_count_output("Preg_KB_Out/Primed_Arc/output_mtx_em/", name="output", tcc=FALSE)
