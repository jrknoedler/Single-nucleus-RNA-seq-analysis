...
output <- "Seurat/MeA_IndependentAnalysis/MeA_Merged_Clusterfuck_Marchredo_0.1logcounts_inhibitory"



mySeurat <- readRDS("Seurat/MeA_IndependentAnalysis/MeA_CCAfiltered3_res1.2.rds")
mySeurat <- subset(mySeurat, idents=c("0","3","8","12","13","5","9","25","14","16","17","20","21","22","28","30","31","32","33"), invert=TRUE)
