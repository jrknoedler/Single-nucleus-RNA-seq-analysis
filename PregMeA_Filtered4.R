...
output <- "Seurat/PregMeA_Exploratory/PregMeA_Filtered4"
...
mySeurat <- readRDS("Seurat/PregMeA_Exploratory/PregMeA_Filtered3.rds")
mySeurat <- subset(mySeurat, idents=c("12","25","19"), invert=TRUE)
