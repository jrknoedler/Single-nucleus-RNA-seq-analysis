...
output <- "Seurat/BNSTMacosko/Macosko_JRK_Integrated_varanchors"
library(Seurat)
#library(cowplot)
#library(reticulate)
#library(ggplot2)
...
snEsr1 <- readRDS("Seurat/BNST_IndependentAnalysis/BNST_Fullmerge_Test_prepaperreclusterRound4_sexclude_malat1regress_filtered5_2res1.2_30pcsredo.rds")
hvg1 <- snEsr1@assays$SCT@var.features
hvg1 <- unlist(hvg1)
hvg1 <- as.matrix(hvg1)

macosko <- readRDS("Seurat/BNSTMacosko/Macosko_BNST_Exploratory.rds")
