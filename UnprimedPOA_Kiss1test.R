...
output <- "Seurat/POA_IndependentAnalysis/POA_Unprimed_Kiss1opt_500"
...
spliced <- read_count_output("Kallisto_Bus_Kiss1Opt_Out/POA_Unprimed/counts_unfiltered/", name="spliced", tcc=FALSE)
unspliced <- read_count_output("Kallisto_Bus_Kiss1Opt_Out/POA_Unprimed/counts_unfiltered/", name="unspliced", tcc=FALSE)
...
Intact <- CreateSeuratObject(counts = Merged, project = "Unprimed", min.cells=3, min.features=500)
Intact
head(Intact[[]])
