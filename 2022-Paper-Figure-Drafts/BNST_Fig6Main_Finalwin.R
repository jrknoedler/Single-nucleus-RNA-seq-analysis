...
library(pheatmap)
library(patchwork)
output <- "X:/Seurat/BNST_IndependentAnalysis/BNST_Figs6dotplot"
...
v1 <- ggplot(glutdat, aes(y=Tac1, x=ident, fill=split)) + geom_violin(trim=TRUE,  scale="width") +scale_fill_manual(values=c("royalblue3","deeppink1","chartreuse3"))+ theme_classic() +theme(axis.title.x=element_blank(), axis.ticks=element_blank(), axis.text.x=element_blank(), axis.text.y=element_blank(), axis.title.y=element_blank())+theme(legend.position="none") +theme(axis.line=element_line(color="black", size=1)) + scale_y_continuous(breaks=seq(0,4,1))
...
v2 <- ggplot(glutdat, aes(y=Synpr, x=ident, fill=split)) + geom_violin(trim=TRUE,  scale="width") +scale_fill_manual(values=c("royalblue3","deeppink1","chartreuse3"))+ theme_classic() +theme(axis.title.x=element_blank(), axis.ticks=element_blank(), axis.text.x=element_blank(), axis.text.y=element_blank(), axis.title.y=element_blank()) +theme(legend.position="none") +theme(axis.line=element_line(color="black", size=1)) + scale_y_continuous(breaks=seq(0,4,1))
...
v3 <- ggplot(glutdat, aes(y=Cck, x=ident, fill=split)) + geom_violin(trim=TRUE,  scale="width") +scale_fill_manual(values=c("royalblue3","deeppink1","chartreuse3"))+ theme_classic() +theme(axis.title.x=element_blank(), axis.ticks=element_blank(), axis.text.x=element_blank(), axis.text.y=element_blank(), axis.title.y=element_blank())+theme(legend.position="none") +theme(axis.line=element_line(color="black", size=1)) + scale_y_continuous(breaks=seq(0,4,1))
...
v5 <- ggplot(glutdat, aes(y=Adra1a, x=ident, fill=split)) + geom_violin(trim=TRUE,  scale="width") +scale_fill_manual(values=c("royalblue3","deeppink1","chartreuse3"))+ theme_classic() +theme(axis.title.x=element_blank(), axis.ticks=element_blank(), axis.text.x=element_blank(), axis.text.y=element_blank(), axis.title.y=element_blank())+theme(legend.position="none") +theme(axis.line=element_line(color="black", size=1)) + scale_y_continuous(breaks=seq(0,4,1))
...
v6 <- ggplot(glutdat, aes(y=Pura, x=ident, fill=split)) + geom_violin(trim=TRUE,  scale="width") +scale_fill_manual(values=c("royalblue3","deeppink1","chartreuse3"))+ theme_classic() +theme(axis.title.x=element_blank(), axis.ticks=element_blank(), axis.text.x=element_blank(), axis.text.y=element_blank(), axis.title.y=element_blank())+theme(legend.position="none") +theme(axis.line=element_line(color="black", size=1)) + scale_y_continuous(breaks=seq(0,4,1)) 
...
glutdat <- glut$data
v7 <- ggplot(glutdat, aes(y=Greb1, x=ident, fill=split)) + geom_violin(trim=TRUE,  scale="width") +scale_fill_manual(values=c("royalblue3","deeppink1","chartreuse3"))+ theme_classic() +theme(axis.title.x=element_blank(), axis.ticks=element_blank(), axis.text.x=element_blank(), axis.text.y=element_blank(), axis.title.y=element_blank())+theme(legend.position="none") +theme(axis.line=element_line(color="black", size=1)) + scale_y_continuous(breaks=seq(0,4,1))
...
v9 <- ggplot(glutdat, aes(y=Phf21b, x=ident, fill=split)) + geom_violin(trim=TRUE,  scale="width") +scale_fill_manual(values=c("royalblue3","deeppink1","chartreuse3"))+ theme_classic() +theme(axis.title.x=element_blank(), axis.ticks=element_blank(), axis.text.x=element_blank(), axis.text.y=element_blank(), axis.title.y=element_blank())+theme(legend.position="none") +theme(axis.line=element_line(color="black", size=1)) + scale_y_continuous(breaks=seq(0,4,1))
...
v10 <- ggplot(glutdat, aes(y=Kcnh7, x=ident, fill=split)) + geom_violin(trim=TRUE,  scale="width") +scale_fill_manual(values=c("royalblue3","deeppink1","chartreuse3"))+ theme_classic() +theme(axis.title.x=element_blank(), axis.ticks=element_blank(), axis.text.x=element_blank(), axis.text.y=element_blank(), axis.title.y=element_blank())+theme(legend.position="none") +theme(axis.line=element_line(color="black", size=1)) + scale_y_continuous(breaks=seq(0,4,1))
...
v11 <- ggplot(glutdat, aes(y=Sox5, x=ident, fill=split)) + geom_violin(trim=TRUE,  scale="width") +scale_fill_manual(values=c("royalblue3","deeppink1","chartreuse3"))+ theme_classic() +theme(axis.title.x=element_blank(), axis.ticks=element_blank(), axis.text.x=element_blank(), axis.text.y=element_blank(), axis.title.y=element_blank())+theme(legend.position="none") +theme(axis.line=element_line(color="black", size=1)) + scale_y_continuous(breaks=seq(0,4,1))
...
v12 <- ggplot(glutdat, aes(y=Fam19a2, x=ident, fill=split)) + geom_violin(trim=TRUE,  scale="width") +scale_fill_manual(values=c("royalblue3","deeppink1","chartreuse3"))+ theme_classic() +theme(axis.title.x=element_blank(), axis.ticks=element_blank(), axis.text.x=element_blank(), axis.text.y=element_blank(), axis.title.y=element_blank())+theme(legend.position="none") +theme(axis.line=element_line(color="black", size=1)) + scale_y_continuous(breaks=seq(0,4,1))
...
v13 <- ggplot(glutdat, aes(y=Etl4, x=ident, fill=split)) + geom_violin(trim=TRUE,  scale="width") +scale_fill_manual(values=c("royalblue3","deeppink1","chartreuse3"))+ theme_classic() +theme(axis.title.x=element_blank(), axis.ticks=element_blank(), axis.text.x=element_blank(), axis.text.y=element_blank(), axis.title.y=element_blank())+theme(legend.position="none") +theme(axis.line=element_line(color="black", size=1)) + scale_y_continuous(breaks=seq(0,4,1))
...
v15 <- ggplot(glutdat, aes(y=Ap1s2, x=ident, fill=split)) + geom_violin(trim=TRUE,  scale="width") +scale_fill_manual(values=c("royalblue3","deeppink1","chartreuse3"))+ theme_classic() +theme(axis.title.x=element_blank(), axis.ticks=element_blank(), axis.text.x=element_blank(), axis.text.y=element_blank(), axis.title.y=element_blank())+theme(legend.position="none") +theme(axis.line=element_line(color="black", size=1)) + scale_y_continuous(breaks=seq(0,4,1))
...
v17 <- ggplot(glutdat, aes(y=Tiparp, x=ident, fill=split)) + geom_violin(trim=TRUE,  scale="width") +scale_fill_manual(values=c("royalblue3","deeppink1","chartreuse3"))+ theme_classic() +theme(axis.title.x=element_blank(), axis.ticks=element_blank(), axis.text.x=element_blank(), axis.text.y=element_blank(), axis.title.y=element_blank())+theme(legend.position="none") +theme(axis.line=element_line(color="black", size=1)) + scale_y_continuous(breaks=seq(0,4,1))

glut <- VlnPlot(mySeurat, features=c("Col25a1"), idents=c("17"), pt.size=0, split.by="Hormone")

glutdat <- glut$data

v18 <- ggplot(glutdat, aes(y=Col25a1, x=ident, fill=split)) + geom_violin(trim=TRUE,  scale="width") +scale_fill_manual(values=c("royalblue3","deeppink1","chartreuse3"))+ theme_classic() +theme(axis.title.x=element_blank(), axis.ticks=element_blank(), axis.text.x=element_blank(), axis.text.y=element_blank(), axis.title.y=element_blank())+theme(legend.position="none") +theme(axis.line=element_line(color="black", size=1)) + scale_y_continuous(breaks=seq(0,4,1))
