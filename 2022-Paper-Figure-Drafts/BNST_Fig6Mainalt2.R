...
v2 <- ggplot(glutdat, aes(y=Gad1, x=factor(ident, levels=mylevels))) + geom_violin(trim=TRUE, fill="dark gray",  scale="width") + theme_classic() +theme(axis.title.x=element_blank(), axis.text.x=element_blank(), axis.text.y=element_text(size=80, color="black"), axis.title.y=element_blank()) +theme(axis.line=element_line(color="black", size=2)) + scale_y_continuous(breaks=seq(0,4,1))
...
v3 <- ggplot(glutdat, aes(y=Cyp19a1, x=factor(ident, levels=mylevels))) + geom_violin(trim=TRUE, fill="dark gray",  scale="width") + theme_classic() +theme(axis.title.x=element_blank(), axis.text.x=element_blank(), axis.text.y=element_text(size=80, color="black"), axis.title.y=element_blank()) +theme(axis.line=element_line(color="black", size=2)) + scale_y_continuous(breaks=seq(0,4,1))
...
v4 <- ggplot(glutdat, aes(y=Tac1, x=factor(ident, levels=mylevels))) + geom_violin(trim=TRUE, fill="dark gray",  scale="width") + theme_classic() +theme(axis.title.x=element_blank(), axis.text.x=element_blank(), axis.text.y=element_text(size=80, color="black"), axis.title.y=element_blank()) +theme(axis.line=element_line(color="black", size=2)) + scale_y_continuous(breaks=seq(0,4,1))
