...
output <- "X:/Seurat/BNST_IndependentAnalysis/BNST_Fig6Revised"
...
CPM <- ggplot(BNSTout, aes(y=factor(mainplotgenes, levels=rev(mainplotgenes)), x=CPM, color=log10(max))) +cowplot::theme_nothing() + geom_point(size=30, shape=21) + scale_color_gradientn(colors=c("white","red"), limits=c(2.2,3.7)) +  theme(axis.line  = element_blank())   + theme(axis.title=element_blank()) + labs(x="") + theme(axis.text.x = element_blank()) + theme(axis.ticks = element_blank())
pdf(file=paste0(output,"Sharedcpmscalebar.pdf"))
ggplot(BNSTout, aes(y=factor(mainplotgenes, levels=rev(mainplotgenes)), x=CPM, color=log10(max))) +cowplot::theme_cowplot() + geom_point(size=30, shape=21) + scale_color_gradientn(colors=c("white","red"), limits=c(2.2,3.7), breaks=c(2,4) +  theme(axis.line  = element_blank())   + theme(axis.title=element_blank()) + labs(x="") + theme(axis.text.x = element_blank()) + theme(axis.ticks = element_blank()) +guides(colour = guide_colorbar(ticks=FALSE))
dev.off()
...
((v1/v2/v3/v4/v5/v6/v7/v8)|CPM) + plot_layout(widths=c("1","0.05")) 
dev.off()

glut <- VlnPlot(mySeurat, features=c("Tac1"), idents=c("18"), pt.size=0, split.by="Hormone")

glutdat <- glut$data
vt <- ggplot(glutdat, aes(y=Tac1, x=ident, fill=split)) + geom_violin(trim=TRUE,  scale="width") +scale_fill_manual(values=c("blue","deeppink1","green"))+ theme_classic() +theme(axis.title.x=element_blank(), axis.text.x=element_blank(), axis.ticks=element_blank(), axis.text.y=element_blank(), axis.title.y=element_blank())+theme(legend.position="none") +theme(axis.line=element_line(color="black", size=1)) + scale_y_continuous(breaks=seq(0,4,1))
...
glutdat <- glut$data
vs1 <- ggplot(glutdat, aes(y=Etv1, x=ident, fill=split)) + geom_violin(trim=TRUE, scale="width") + scale_fill_manual(values=c("blue","deeppink1","green"))+theme_classic() +theme(axis.title.x=element_blank(), axis.text.x=element_blank(), axis.ticks=element_blank(), axis.text.y=element_blank(), axis.title.y=element_blank()) +theme(axis.line=element_line(color="black", size=1)) + scale_y_continuous(breaks=seq(0,4,1)) + theme(legend.position = "none")

glut <- VlnPlot(mySeurat, features=c("Maml2"), idents=c("18"), pt.size=0, split.by="Hormone")

glutdat <- glut$data
vs2 <- ggplot(glutdat, aes(y=Maml2, x=ident, fill=split)) + geom_violin(trim=TRUE, scale="width") + scale_fill_manual(values=c("blue","deeppink1","green"))+theme_classic() +theme(axis.title.x=element_blank(), axis.text.x=element_blank(), axis.ticks=element_blank(), axis.text.y=element_blank(), axis.title.y=element_blank()) +theme(axis.line=element_line(color="black", size=1)) + scale_y_continuous(breaks=seq(0,4,1)) + theme(legend.position = "none")

glut <- VlnPlot(mySeurat, features=c("B3gnt2"), idents=c("18"),pt.size=0, split.by="Hormone")

glutdat <- glut$data
vs3 <- ggplot(glutdat, aes(y=B3gnt2, x=ident, idents=c("18"),fill=split)) + geom_violin(trim=TRUE, scale="width") + scale_fill_manual(values=c("blue","deeppink1","green"))+theme_classic() +theme(axis.title.x=element_blank(), axis.ticks=element_blank(), axis.text.x=element_blank(), axis.text.y=element_blank(), axis.title.y=element_blank()) +theme(axis.line=element_line(color="black", size=1)) + scale_y_continuous(breaks=seq(0,4,1)) + theme(legend.position = "none")

glut <- VlnPlot(mySeurat, features=c("Nfib"), idents=c("18"),pt.size=0, split.by="Hormone")

glutdat <- glut$data
vs4 <- ggplot(glutdat, aes(y=Nfib, x=ident, fill=split)) + geom_violin(trim=TRUE, scale="width") + scale_fill_manual(values=c("blue","deeppink1","green"))+theme_classic() +theme(axis.title.x=element_blank(), axis.text.x=element_blank(), axis.ticks=element_blank(), axis.text.y=element_blank(), axis.title.y=element_blank()) +theme(axis.line=element_line(color="black", size=1)) + scale_y_continuous(breaks=seq(0,4,1)) + theme(legend.position = "none")

glut <- VlnPlot(mySeurat, features=c("Moxd1"), idents=c("18"), pt.size=0, split.by="Hormone")

glutdat <- glut$data
vs5 <- ggplot(glutdat, aes(y=Moxd1, x=ident, fill=split)) + geom_violin(trim=TRUE, scale="width") + scale_fill_manual(values=c("blue","deeppink1","green"))+theme_classic() +theme(axis.title.x=element_blank(), axis.text.x=element_blank(), axis.ticks=element_blank(), axis.text.y=element_blank(), axis.title.y=element_blank()) +theme(axis.line=element_line(color="black", size=1)) + scale_y_continuous(breaks=seq(0,4,1)) + theme(legend.position = "none")

glut <- VlnPlot(mySeurat, features=c("Rreb1"),idents=c("18"), pt.size=0, split.by="Hormone")

glutdat <- glut$data
vs6 <- ggplot(glutdat, aes(y=Rreb1, x=ident, fill=split)) + geom_violin(trim=TRUE, scale="width") + scale_fill_manual(values=c("blue","deeppink1","green"))+theme_classic() +theme(axis.title.x=element_blank(), axis.text.x=element_blank(), axis.ticks=element_blank(), axis.text.y=element_blank(), axis.title.y=element_blank()) +theme(axis.line=element_line(color="black", size=1)) + scale_y_continuous(breaks=seq(0,4,1)) + theme(legend.position = "none") 

glut <- VlnPlot(mySeurat, features=c("Syne2"),idents=c("18"), pt.size=0, split.by="Hormone")

glutdat <- glut$data
vs7 <- ggplot(glutdat, aes(y=Syne2, x=ident, fill=split)) + geom_violin(trim=TRUE, scale="width") + scale_fill_manual(values=c("blue","deeppink1","green"))+theme_classic() +theme(axis.title.x=element_blank(), axis.text.x=element_blank(), axis.ticks=element_blank(), axis.text.y=element_blank(), axis.title.y=element_blank()) +theme(axis.line=element_line(color="black", size=1)) + scale_y_continuous(breaks=seq(0,4,1)) + theme(legend.position = "none") 
...
glutdat <- glut$data
vs1 <- ggplot(glutdat, aes(y=Arid5b, x=ident, fill=split)) + geom_violin(trim=TRUE, scale="width") + scale_fill_manual(values=c("blue","deeppink1","green"))+theme_classic() +theme(axis.title.x=element_blank(), axis.text.x=element_blank(), axis.ticks=element_blank(), axis.text.y=element_blank(), axis.title.y=element_blank()) +theme(axis.line=element_line(color="black", size=1)) + scale_y_continuous(breaks=seq(0,4,1)) + theme(legend.position = "none")

glut <- VlnPlot(mySeurat, features=c("Sdk1"), idents=c("18"),pt.size=0, split.by="Hormone")

glutdat <- glut$data
vs3 <- ggplot(glutdat, aes(y=Sdk1, x=ident, idents=c("18"),fill=split)) + geom_violin(trim=TRUE, scale="width") + scale_fill_manual(values=c("blue","deeppink1","green"))+theme_classic() +theme(axis.title.x=element_blank(), axis.ticks=element_blank(), axis.text.x=element_blank(), axis.text.y=element_blank(), axis.title.y=element_blank()) +theme(axis.line=element_line(color="black", size=1)) + scale_y_continuous(breaks=seq(0,4,1)) + theme(legend.position = "none")

glut <- VlnPlot(mySeurat, features=c("Slc44a5"), idents=c("18"),pt.size=0, split.by="Hormone")

glutdat <- glut$data
vs4 <- ggplot(glutdat, aes(y=Slc44a5, x=ident, fill=split)) + geom_violin(trim=TRUE, scale="width") + scale_fill_manual(values=c("blue","deeppink1","green"))+theme_classic() +theme(axis.title.x=element_blank(), axis.text.x=element_blank(), axis.ticks=element_blank(), axis.text.y=element_blank(), axis.title.y=element_blank()) +theme(axis.line=element_line(color="black", size=1)) + scale_y_continuous(breaks=seq(0,4,1)) + theme(legend.position = "none")

glut <- VlnPlot(mySeurat, features=c("Sox6"), idents=c("18"), pt.size=0, split.by="Hormone")

glutdat <- glut$data
vs5 <- ggplot(glutdat, aes(y=Sox6, x=ident, fill=split)) + geom_violin(trim=TRUE, scale="width") + scale_fill_manual(values=c("blue","deeppink1","green"))+theme_classic() +theme(axis.title.x=element_blank(), axis.text.x=element_blank(), axis.ticks=element_blank(), axis.text.y=element_blank(), axis.title.y=element_blank()) +theme(axis.line=element_line(color="black", size=1)) + scale_y_continuous(breaks=seq(0,4,1)) + theme(legend.position = "none")
