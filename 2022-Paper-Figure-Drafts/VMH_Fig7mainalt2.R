...
output <- "Seurat/VMH_IndependentAnalysis/VMH_Fig7main_reclusterrerun"
...
VlnPlot(mySeurat, features=c("Maml2","Phf21b","Gfra1","Rnf19a","Galnt14","Tmem200a","Amotl1","Mylk","Alk","Trpc3","Slc24a1","Pou6f2"), ncol=1, pt.size=0)
dev.off()
glut <- VlnPlot(mySeurat, features=c("Cckar"), pt.size=0)
glutdat <- glut$data
