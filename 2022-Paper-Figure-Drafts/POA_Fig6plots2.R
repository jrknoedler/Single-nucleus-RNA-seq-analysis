...
write.table(mySeurat@active.ident, file=paste0(output,"clusterID.txt"), quote=FALSE, sep="\t", col.names=TRUE)
Emb <- Embeddings(mySeurat, reduction = "umap")
write.table(Emb, file=paste0(output,"_umapembeddings.txt"))
pdf(file=paste0(output,"Malecluster.pdf"))
DimPlot(mySeurat, cols=c("0"="light gray", "1"="light gray", "2"="light gray", "3"="light gray", "4"="light gray", "5"="light gray", "6"="light gray", "7"="light gray", "8"="pink", "9"="light gray", "10"="blue", "11"="blue", "12"="orange", "13"="blue", "14"="light gray", "15"="light gray", "16"="light gray", "17"="light gray", "18"="light gray", "19"="blue", "20"="blue", "21"="blue", "22"="light gray", "23"="light gray", "24"="blue", "25"="orange", "26"="orange", "27"="light gray", "28"="light gray", "29"="light gray", "30"="light gray", "31"="light gray", "32"="light gray", "33"="blue", "34"="light gray", "35"="light gray", "36"="light gray", "37"="light gray", "38"="light gray"), label=FALSE, reduction="umap")
dev.off() 
