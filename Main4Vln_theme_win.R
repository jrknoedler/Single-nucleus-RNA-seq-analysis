...
vmhtypemarkers <- read.table("X:/DotPlotMarkerLists/VMH_reorderedfinal_CPM.txt", header=FALSE)
...
pdf(file="X:/Seurat/VMH_ViolinEdittest.pdf", width=60, height=125.6)
...
typemarkers <- read.table("X:/DotPlotMarkerLists/MeA_ReorderedFinal_CPM.txt", header=FALSE)
...
pdf(file="X:/Seurat/MeA_ViolinTest.pdf", width=60, height=154.8)
...
pdf(file="X:/Seurat/MeA_ViolinTest_names.pdf", width=60, height=154.8)
