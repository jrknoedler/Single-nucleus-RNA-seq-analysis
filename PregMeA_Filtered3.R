...
output <- "Seurat/PregMeA_Exploratory/PregMeA_Filtered3"
...
mySeurat <- readRDS("Seurat/PregMeA_Exploratory/PregMeA_Filtered2.rds")
mySeurat <- subset(mySeurat, idents=c("11","27"), invert=TRUE)
