...
output <- "Seurat/BNST_IndependentAnalysis/BNST_Merged_Clusterfuck_CCA_10pct_"

mySeurat <- readRDS("Seurat/BNST_IndependentAnalysis/BNST_Fullmerge_Test_CCAtestallstandardscale_filtered3CCAscaledata.rds")
