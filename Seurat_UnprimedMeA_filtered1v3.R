...
output <- "Seurat/UnprimedMeA_Exploratory/UnprimedMeA_emptyDrops_filtered1v3_30pcs_lowfdr"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
...
mySeurat <- readRDS("Seurat/UnprimedMeA_Exploratory/UnprimedMeA_emptyDrops_.00001FDR_moreiters500lower500k.rds")
mySeurat <- subset(mySeurat, idents=c("0","3","7"), invert=TRUE)
