...
BNSTtypemarkers <- read.table("DotPlotMarkerLists/BNST_ReorderedFinalalternate_CPM.txt", header=FALSE)
...
plotphf <- plotph & theme_nothing() & theme(axis.line.x=element_line(color="black", size=1)) & scale_fill_manual(values=c(rep("blue",4), rep("red",32)))
...
plotf <- plot & theme_nothing() & theme(axis.line.x=element_line(color="black", size=1)) & theme(panel.background=element_rect(fill="transparent", color=NA), plot.background=element_rect(fill="transparent", color=NA)) & scale_fill_manual(values=c(rep("blue",4), rep("red",32)))
...
#ggsave("Seurat/BNST_ViolinTest.pdf",BNSTvln, bg='transparent')
pdf(file="Seurat/BNST_ViolinTest_alternate.pdf", width=60, height=163)
...
vmhtypemarkers <- read.table("DotPlotMarkerLists/VMH_reorderedfinaledited_CPM.txt", header=FALSE)
...
pdf(file="Seurat/VMH_ViolinTest_altmarkers.pdf", width=60, height=126)
VlnPlot(VMH, features=vmhtypemarkers, pt.size=0, ncol=1)
dev.off()

plot <- VlnPlot(VMH, features=rev(vmhtypemarkers), pt.size=0, ncol=1)
plotf <- plot& theme_nothing() & theme(axis.line.x=element_line(color="black", size=1)) & theme(panel.background=element_rect(fill="transparent", color=NA), plot.background=element_rect(fill="transparent", color=NA)) &  scale_fill_manual(values=c(rep("blue",17), rep("red",10)))
...
typemarkers <- read.table("DotPlotMarkerLists/MeA_ReorderedFinalalternate_CPM.txt", header=FALSE)
...
plotf <- plot & theme_nothing() & theme(axis.line.x=element_line(color="black", size=1)) & theme(panel.background=element_rect(fill="transparent", color=NA), plot.background=element_rect(fill="transparent", color=NA)) & scale_fill_manual(values=c(rep("blue",19), rep("red",15)))


pdf(file="Seurat/MeA_ViolinTest_alternate.pdf", width=60, height=154.8)
...
POAtypemarkers <- read.table("DotPlotMarkerLists/POA_ReorderedFinalalternate_CPM.txt", header=FALSE)
...
plotf <- plot& theme_nothing() & theme(axis.line.x=element_line(color="black", size=1)) & theme(panel.background=element_rect(fill="transparent", color=NA), plot.background=element_rect(fill="transparent", color=NA)) &  scale_fill_manual(values=c(rep("blue",14), rep("red",26)))

pdf(file="Seurat/POA_ViolinTest_alternate.pdf", width=60, height=180)
