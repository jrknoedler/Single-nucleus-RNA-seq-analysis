output <- "Seurat/MeA_IndependentAnalysis/MeA_IndependentFiltered2_10pcs"
...
Intact <- readRDS("Seurat/MeA_IndependentAnalysis/MeA_IndependentFiltered1_10pcs_Intact.rds")
Intact <- subset(Intact, idents=c("26","25","21","20"), invert=TRUE)
