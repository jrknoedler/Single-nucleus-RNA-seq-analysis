...
output <- "Seurat/POABNST_DEExclusionClusterTests/POA_DEexcluded/vln/"
...
mySeurat <- readRDS("Seurat/BNST_POA_PrimedvUnprimedClusterTests/POA_PrimedvUnprimed_ExcludedDE.rds")
