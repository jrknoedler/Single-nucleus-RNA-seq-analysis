...
output <- "Seurat/MeA_IndependentAnalysis/MeA_JuneMerge_filtered2"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
library(dplyr)
mySeurat <- readRDS("Seurat/MeA_IndependentAnalysis/MeA_JuneMerge_filtered1.rds")
mySeurat <- subset(mySeurat, idents=c("23","25","33","35","3"), invert=TRUE)
