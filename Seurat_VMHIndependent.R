...
sampleID <- "MaleVMH"
directory <- "MaleVMHIntact/outs/filtered_feature_bc_matrix"
output <- "Seurat/VMH_IndependentAnalysis/VMH_IndependentRound1_"
...
Unprimed
Castrate.data <- read_count_output("Kallisto_Bus_Output/CastrateVMH/combined_counts_em/", name="output", tcc=FALSE)
