...
output <- "Seurat/PregVMH_Exploratory/PregVMH_Filtered1"
...
mySeurat <- readRDS("Seurat/PregVMH_Exploratory/PregVMH_1stPass.rds")
mySeurat <- subset(mySeurat, idents=c("0","22","6","34","37"), invert=TRUE)
