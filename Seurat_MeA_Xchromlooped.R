...
output <- "Seurat/MeA_IndependentAnalysis/Xchromdiff/MvF_Xchromdiff"
...
mySeurat <- readRDS("Seurat/MeA_IndependentAnalysis/MeA_Fullmerge_Test_emptyDrops_SCT_filtered1.rds")
