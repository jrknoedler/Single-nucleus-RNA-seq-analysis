...
output <- "Seurat/VMH_Anderson/AndersonFemale_GliaFilt7"
...
mySeurat <- readRDS("Seurat/VMH_Anderson/AndersonFemale_GliaFilt6.rds")
mySeurat <- subset(mySeurat, idents=c("34","37","38","44","46"), invert=TRUE)
...
DotPlot(SeuratScaled, features=c("Gad1","Slc17a6","Esr1","Cckar","Mbp","Plp1","Cxcr1l","Inpp5d"))
dev.off()
