...
output <- "Seurat/POA_MalevUnprimedMerged_Exploratory/MaleUnprimed_doubletsremoved_filtered2"
...
mySeurat <- readRDS("Seurat/POA_MalevUnprimedMerged_Exploratory/MaleUnprimed_doubletsremoved_filtered1.rds")
mySeurat
filteredSeurat <- subset(mySeurat, idents=c("26"), invert=TRUE)
