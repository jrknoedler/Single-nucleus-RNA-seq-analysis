output <- "Seurat/POA_IndependentAnalysis/POA_Fullmerge_Test_CCAtestallstandardscaleDEGenforced_filtered4"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
...
POA.comb <- readRDS("Seurat/POA_IndependentAnalysis/POA_Fullmerge_Test_CCAtestallstandardscaleDEGenforced_filtered3CCAscaledata_DEGsonly.rds")
POA.comb <- subset(POA.comb, idents=c("34","37"), invert=TRUE) 
