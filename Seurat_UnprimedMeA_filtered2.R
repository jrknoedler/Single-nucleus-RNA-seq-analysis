...
output <- "Seurat/UnprimedMeA_Exploratory/UnprimedMeA_emptyDrops_filtered2_30pcs_15per"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
...
mySeurat <- readRDS("Seurat/UnprimedMeA_Exploratory/UnprimedMeA_emptyDrops_filtered1_30pcs_15per.rds")
mySeurat <- subset(mySeurat, idents=c("20","31","26","25","23","2"), invert=TRUE)
...
bcmvn
nExp_poi <- round(0.10*nrow(mySeurat@meta.data))
