...
output <- "Seurat/MeA_IndependentAnalysis/MeA_IndependentFiltered1_10pcs"
...
Intact <- readRDS("Seurat/MeA_IndependentAnalysis/MeA_IndependentFiltered1__Intact.rds")
