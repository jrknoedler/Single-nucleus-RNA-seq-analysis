...
output <- "Seurat/BNST_IndependentAnalysis/BNST_Fullmerge_Test_Esr1striatum1stepfilt_sexclude_malat1regress_30pcsres1.2"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
...
mySeurat <- subset(mySeurat, idents=c("30","38","43","39","27"), invert=TRUE)
