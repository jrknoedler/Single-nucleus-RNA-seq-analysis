...
output <- "Seurat/MeA_IndependentAnalysis/MeA_Merged_Clusterfuck_Filtered2_"

mySeurat <- readRDS("Seurat/MeA_IndependentAnalysis/MeA_CCAfiltered2_mayfinal.rds")
...
uniqueclustassign <- uniqueclustgenes[uniqueclustgenes$pct.exp > 10,]
uniqueclustassign
write.csv(uniqueclustassign, file=paste0(output,"MeA_clusterspecDEGs_10pct.csv"))
