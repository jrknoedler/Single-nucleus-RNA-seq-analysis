...
output <- "Seurat/VMH_Barcode_Transfer/VMH_Barcode_Lift_Filtered1"
...
mySeurat <- readRDS("Seurat/VMH_Barcode_Transfer/VMH_Barcode_Lift.rds")
mySeurat <- subset(mySeurat, idents=c("21","31"), invert=TRUE)
