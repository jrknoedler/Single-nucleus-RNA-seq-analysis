...
output <- "Seurat/MeA_IndependentAnalysis/MeA_MergedFinal_Filteredalt"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
...
mySeurat <- readRDS("Seurat/MeA_IndependentAnalysis/MeA_Fullmerge_Final_.rds")
mySeurat <- subset(mySeurat, idents=c("1","4","5","18","20","31","39"), invert=TRUE)
