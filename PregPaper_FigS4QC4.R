...
output <- "Joe_Sherlock_Backup4/Joe_Sherlock_Backup/Pregnancy_Figures/snRNAseqQC_Regressed_Nomale"
...
mySeurat <- readRDS("Joe_Sherlock_Backup3/Joe_Sherlock_Backup/Pregnancy_Figures/All_snRNAseq_regressed.rds")

mySeurat <- subset(mySeurat, subset=sex=="Female")
...
pc <- DimPlot(mySeurat, reduction="umap", label=FALSE, cols=c("#8B5E3C", "#F280AA","#00A651"), group.by="Hormone", shuffle=TRUE)
...
#pcblack <- DimPlot(mySeurat, reduction="umap", label=FALSE, cols=c("#8B5E3C", "#F280AA","#00A651"), group.by="Hormone", shuffle=TRUE)
