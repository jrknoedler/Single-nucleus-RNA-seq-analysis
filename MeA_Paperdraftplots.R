...
output <- "Seurat/MeA_IndependentAnalysis/MeA_Merge_Paperplots"
...
unlist(genes.10x)
UpMale <- read.table("Genelists/MeA_MvP_UpMale1.5.txt")
unlist(UpMale)
...
UpPrimed <- read.table("Genelists/MeA_PvU_UpPrimed1.5.txt")
unlist(UpPrimed)
...
UpFemale <- read.table("Genelists/MeA_MvP_Upfemale1.5.txt")
unlist(UpFemale)
