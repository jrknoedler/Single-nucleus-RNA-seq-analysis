...
Primed$sex <- "Primed"
Male$sex <- "Male" 
Primed <- subset(Primed, idents=c("2","13"))
Male <- subset(Male, idents=c("0","13","26","17"))
...
write.csv(markers, file="Seurat/MeA_IndependentAnalysis/MeA_Supergroup3_Full_res1_40pcs_MvP_SDEGsMAST.csv")