...
output <- "Seurat/VMH_Anderson/AndersonFemale_GliaFilt4"
...
mySeurat <- readRDS("Seurat/VMH_Anderson/AndersonFemale_GliaFilt3.rds")
mySeurat <- subset(mySeurat, idents=c("27","37"), invert=TRUE)
