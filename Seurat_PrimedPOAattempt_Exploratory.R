...
output <- "Seurat/PrimedPOAattempt_Bus/PrimedPOA1_1000cutoff"
...
library(ggplot2)
library(dplyr)
Seurat.data <- read_count_output("Kallisto_Bus_Output/PrimedPOAattempt/combined_counts/", name="output", tcc=FALSE)
mySeurat <- CreateSeuratObject(counts = Seurat.data, project = sampleID, min.cells=3, min.features=1000)
mySeurat
