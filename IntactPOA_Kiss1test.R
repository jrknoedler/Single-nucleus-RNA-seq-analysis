...
output <- "Seurat/POA_IndependentAnalysis/POA_Intact_Kiss1opt_500"
...
spliced <- read_count_output("Kallisto_Bus_Kiss1Opt_Out/POA_Intact/counts_unfiltered/", name="spliced", tcc=FALSE)
unspliced <- read_count_output("Kallisto_Bus_Kiss1Opt_Out/POA_Intact/counts_unfiltered/", name="unspliced", tcc=FALSE)
