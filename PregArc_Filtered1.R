...
output <- "Seurat/PregArc_Exploratory/PregArc_Filtered1"
...
mySeurat <- readRDS("Seurat/PregArc_Exploratory/PregArc_1stPass.rds")
mySeurat <- subset(mySeurat, idents=c("0","1","19"), invert=TRUE)
