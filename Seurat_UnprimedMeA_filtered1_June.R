...
output <- "Seurat/UnprimedMeA_Exploratory/UnprimedMeA_emptyDrops_June_Filtered1"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
...
mySeurat <- readRDS("Seurat/UnprimedMeA_Exploratory/UnprimedMeA_emptyDrops_750lower.001FDR_50000iter.rds")
mySeurat <- subset(mySeurat, idents=c("0","5","10"), invert=TRUE)
