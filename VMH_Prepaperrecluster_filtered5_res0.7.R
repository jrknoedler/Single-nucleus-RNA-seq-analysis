...
output <- "Seurat/VMH_IndependentAnalysis/VMH_Fullmerge_Test_prepaperreclusterRound2_sexclude_malat1regress_filtered5_30pcsres0.7"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
...
mySeurat <- FindClusters(mySeurat, resolution=0.7)
