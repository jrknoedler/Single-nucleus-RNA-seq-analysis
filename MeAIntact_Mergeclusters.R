...
output <- "Seurat/MeA_IndependentAnalysis/MeA_Intact_Curated_40pcs_SH"
...
#dev.off()
Node25.markers <- FindMarkers(mySeurat, ident.1="clustertree", ident.2="25", only.pos=FALSE, min.pct=0.25, min.diff.pct=0.2, logfc.threshold = 0.25, test.use="MAST")
write.csv(Node25.markers, file=paste0(output,"_Node25posmarkers.csv"))
