...
Primed$sex <- "Primed"
Male$sex <- "Male" 
Primed <- subset(Primed, idents=c("5","7","17"))
Male <- subset(Male, idents=c("1","19","20","12"))
...
write.csv(markers, file="Seurat/POA_IndependentAnalysis/POA_Esr1_Excite_Supergroup1_MvP_SDEGs.csv")