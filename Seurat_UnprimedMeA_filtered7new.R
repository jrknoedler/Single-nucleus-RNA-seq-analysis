...
output <- "Seurat/UnprimedMeA_Exploratory/UnprimedMeA_emptyDrops_filtered7_30pcs_lowfdr"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
...
mySeurat <- readRDS("Seurat/UnprimedMeA_Exploratory/UnprimedMeA_emptyDrops_filtered6_30pcs_lowfdr.rds")
