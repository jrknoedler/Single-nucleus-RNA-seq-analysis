...
output <- "Seurat/VMH_Anderson/AndersonFemale_GliaFilt5"
...
mySeurat <- readRDS("Seurat/VMH_Anderson/AndersonFemale_GliaFilt4.rds")
mySeurat <- subset(mySeurat, idents=c("1","5","10","22","37","52"), invert=TRUE)
