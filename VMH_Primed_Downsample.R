...
output <- "Seurat/VMH_IndependentAnalysis/VMH_IndependentFiltered3_Primed_Downsampled"
...
Primed <- readRDS("Seurat/VMH_IndependentAnalysis/VMH_IndependentFiltered2_Primed_30pcs_res1_Primed.rds")
Primed <- subset(Primed, idents=c("23","18","16"), invert=TRUE)
Primed <- subset(Primed, cells=sample(Cells(Primed), 1500))
Primed <- SCTransform(Primed, verbose=TRUE)
Primed <- RunPCA(Primed)
warnings()
Primed <- FindNeighbors(Primed, dims=1:32)
