...
output <- "Seurat/Primed_Arcuate_Exploratory/Primed_Arcuate_Filtered2"
...
mySeurat <- readRDS("Seurat/Primed_Arcuate_Exploratory/Primed_Arcuate_Filtered1.rds")
mySeurat <- subset(mySeurat, idents=c("25","24","19","12"), invert=TRUE)
