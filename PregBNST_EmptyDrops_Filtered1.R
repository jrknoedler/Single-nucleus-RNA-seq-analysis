...
output <- "Seurat/PregBNST_Exploratory/PregBNST_Emptydrops_Filtered1"
...
mySeurat <- readRDS("Seurat/PregBNST_Exploratory/PregnantBNST_emptyDrops_500lower.001FDR_50000iter.rds")
mySeurat <- subset(mySeurat, idents=c("0","1","5","6","14","17","27","29","31","33","34"), invert=TRUE)
