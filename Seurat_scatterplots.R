...
output <- "Seurat/POA_MalevUnprimed_Doubletsremoved/Maleup_Scatter/"
...
MaleUP <- read.table("Genelists/POA_UpMalevUnprimed.txt", header=FALSE)
MaleUP <- unlist(MaleUP)
FemaleUP <- read.table("Genelists/POA_UpUnprimedvMale.txt", header=FALSE)
...
genes.to.label = c("Shisa6","Pdzrn4","Cntnap2","Celf2","Kcnq3","Npas3","Utrn","Syt6","Dock4")
