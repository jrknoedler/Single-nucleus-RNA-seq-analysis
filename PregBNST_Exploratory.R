...
sampleID <- "PregBNST"
output <- "Seurat/PregBNST_Exploratory/PregBNST_1stPass"
...
library(dplyr)
library(Matrix)
Seurat.data <- read_count_output("Preg_KB_Out/Preg_BNST_UpdatedRef2/output_mtx_em/", name="output", tcc=FALSE)
