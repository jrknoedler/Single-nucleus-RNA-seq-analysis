...
output <- "Seurat/POA_MalevUnprimed_DiffExp/POA_MalevUnprimed_scretransformed_diff"
...
mySeurat <- readRDS("Seurat/POA_MalevUnprimedMerged_Exploratory/MaleUnprimed_filtered_Retransformed.rds")
clustercomp <- FindMarkers(mySeurat, ident.1="20", ident.2="8", logfc.threshold=0.1)
write.csv(clustercomp, file=paste0(output,"_maleclustervfemaleclust.csv"))
