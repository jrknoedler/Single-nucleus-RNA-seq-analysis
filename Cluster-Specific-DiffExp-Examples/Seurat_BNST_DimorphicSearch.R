...
output <- "Seurat/BNST_IndependentAnalysis/Paper_DraftAnalysis/MvP30pcs/BNST_MvP_1.5cutoff_0.2fc_stringentcut"
...
sex.dimorphism <- FindMarkers(dsSeurat, assay="RNA", ident.1 = ident1, ident.2=ident2, features=filtered.genelist, min.cells.group=3, logfc.threshold=0.20, min.pct=0, only.pos=FALSE, verbose=TRUE)
