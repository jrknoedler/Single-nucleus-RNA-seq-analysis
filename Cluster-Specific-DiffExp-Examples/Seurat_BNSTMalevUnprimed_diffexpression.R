...
output <- "Seurat/BNST_MalevUnprimed_DiffExp/BNST_MalevUnprimed_1stpass_diff_RNA_Noretrans"
...
mySeurat <- readRDS("Seurat/BNST_MalevUnprimed_Exploratory/BNST_MalevUnprimed_filtered.rds")
DefaultAssay <- "RNA"
