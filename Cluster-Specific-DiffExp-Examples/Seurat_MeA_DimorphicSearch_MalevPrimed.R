...
output <- "Seurat/MeA_IndependentAnalysis/Paper_DraftAnalysis/MvP30Pcs/MeAMvP_Cluster_1.5DESeq2test"
...
mySeurat <- readRDS("Seurat/MeA_IndependentAnalysis/MeA_Fullmerge_Test_emptyDrops_naivemerge_finalhope.rds")
