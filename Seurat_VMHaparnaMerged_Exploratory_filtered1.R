...
output <- "Seurat/VMH_PrimedvMale_AparnaNorm/VMH_MalevPrimed_aparnanorm_filtered1"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
...
Sex.integrated <- readRDS("Seurat/VMH_PrimedvMale_AparnaNorm/VMH_origregress_dropdimorphic_highres.rds")
Sex.integrated <- subset(Sex.integrated, idents=c("27","28","29","30"), invert=TRUE)
