...
output <- "Seurat/UnprimedMeA_Exploratory/UnprimedMeA_emptyDrops_.00001FDR_moreiters500lower500k"
...
head(mtx.data)
set.seed(100)
e.out <- emptyDrops(mtx.data, lower=500, niter=500000)
e.out
is.cell <- e.out$FDR <=0.00001
dim(is.cell)
