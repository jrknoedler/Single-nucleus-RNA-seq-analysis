...
output <- "Seurat/VMH_PrimedvMale_AparnaNorm/VMH_MalevPrimed_aparnanorm_filter0test_newvarextravars"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
...
Sex.integrated <- FindVariableFeatures(Sex.integrated, selection.method="vst", nfeatures=3000)
...
hvg.final
Sex.integrated <- ScaleData(Sex.integrated, vars.to.regress="orig.ident")
