...
output <- "Seurat/BNST_IndependentAnalysis/BNST_Fullmerge_Test_Esr1filtered_sexclude_malat1regress_30pcsres1.2drd3filt2"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
library(dplyr)
mySeurat <- readRDS("Seurat/BNST_IndependentAnalysis/BNST_Fullmerge_Test_Esr1filtered_sexclude_malat1regress_30pcsres1.2drd3filt.rds")
mySeurat <- subset(mySeurat, idents=c("37","34"), invert=TRUE)
