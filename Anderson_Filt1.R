...
output <- "Seurat/VMH_Anderson/Anderson_GliaFilt"
...
mySeurat <- readRDS("Seurat/VMH_Anderson/Anderson_Exploratory.rds")
mySeurat <- subset(mySeurat, idents=c("1","11","13","25","14","22","50","5","7","8","32","23","3","20","28","30","39","47","52","53","54","56"), invert=TRUE)
