...
output <- "Seurat/POA_IndependentAnalysis/POA_Merged_Clusterfuck_Mayredo_10pct_"

mySeurat <- readRDS("Seurat/POA_IndependentAnalysis/POA_Fullmerge_Test_prepaperreclusterRound2_sexclude_malat1regress_filtered3_20pcsres0.9.rds")
