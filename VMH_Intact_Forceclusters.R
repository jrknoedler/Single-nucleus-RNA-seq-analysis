...
output <- "Seurat/VMH_IndependentAnalysis/VMH_IndependentFiltered1_Intact_30pcs_res1"
...
Primed <- readRDS("Seurat/VMH_IndependentAnalysis/VMH_IndependentFiltered1__Intact.rds")
