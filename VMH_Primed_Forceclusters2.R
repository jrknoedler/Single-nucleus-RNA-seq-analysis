...
output <- "Seurat/VMH_IndependentAnalysis/VMH_IndependentFiltered2_Primed_10pcs_res1"
...
Primed <- readRDS("Seurat/VMH_IndependentAnalysis/VMH_IndependentFiltered1_Primed_10pcs_res1_Primed.rds")
Primed <- subset(Primed, idents=c("14","12","15"), invert=TRUE)
