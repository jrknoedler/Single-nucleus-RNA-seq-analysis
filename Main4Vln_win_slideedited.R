...
BNSTtypemarkers <- read.table("X:/DotPlotMarkerLists/BNST_ReorderedFinal_CPM.txt", header=FALSE)
...
plotphf <- plotph & theme(axis.text.x=element_blank(), axis.text.y=element_blank(),axis.ticks=element_blank(), axis.title=element_blank(), plot.title=element_blank()) & scale_fill_manual(values=c(rep("royalblue3",4), rep("red",32)))
...
plotf <- plot & theme(axis.text.x=element_blank(), axis.text.y=element_blank(),axis.ticks=element_blank(), axis.title=element_blank(), plot.title=element_blank()) & scale_fill_manual(values=c(rep("royalblue3",4), rep("red",32)))

pdf(file="X:/Seurat/BNST_ViolinTest.pdf", width=60, height=163)
...
pdf(file="X:/Seurat/VMH_ViolinTest.pdf", width=60, height=126)
VlnPlot(VMH, features=vmhtypemarkers, pt.size=0, ncol=1)
dev.off()

plot <- VlnPlot(VMH, features=rev(vmhtypemarkers), pt.size=0, ncol=1)
plotf <- plot & theme(axis.text.x=element_blank(), axis.text.y=element_blank(), axis.ticks=element_blank(), axis.title=element_blank(), plot.title=element_blank()) & scale_fill_manual(values=c(rep("royalblue3",17), rep("red",10)))
...
plotf <- plot & theme(axis.text.x=element_blank(), axis.text.y=element_blank(), axis.ticks=element_blank(),axis.title=element_blank(), plot.title=element_blank()) & scale_fill_manual(values=c(rep("royalblue3",19), rep("red",15)))
...
POAtypemarkers <- read.table("X:/DotPlotMarkerLists/POA_ReorderedFinal_CPM.txt", header=FALSE)
...
plotf <- plot & theme(axis.text.x=element_blank(), axis.ticks=element_blank(), axis.text.y=element_blank(), axis.title=element_blank(), plot.title=element_blank()) & scale_fill_manual(values=c(rep("royalblue3",14), rep("red",26)))

pdf(file="X:/Seurat/POA_ViolinTest.pdf", width=60, height=180)
