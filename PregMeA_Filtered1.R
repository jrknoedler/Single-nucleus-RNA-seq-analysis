...
output <- "Seurat/PregMeA_Exploratory/PregMeA_Filtered1"
...
mySeurat <- readRDS("Seurat/PregMeA_Exploratory/PregMeA_1stPass.rds")
mySeurat <- subset(mySeurat, idents=c("31","35","39","22","12"), invert=TRUE)
