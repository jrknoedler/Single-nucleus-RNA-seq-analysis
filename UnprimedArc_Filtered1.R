...
output <- "Seurat/Primed_Arcuate_Exploratory/Primed_Arcuate_Filtered3"
...
mySeurat <- readRDS("Seurat/Primed_Arcuate_Exploratory/Primed_Arcuate_Filtered2.rds")
mySeurat <- subset(mySeurat, idents=c("0","3"), invert=TRUE)
