...
output <- "Seurat/UnprimedMeA_Exploratory/UnprimedMeA_emptyDrops_filtered4_30pcs_lowfdr"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
...
mySeurat <- readRDS("Seurat/UnprimedMeA_Exploratory/UnprimedMeA_emptyDrops_filtered3_30pcs_lowfdr.rds")
mySeurat <- subset(mySeurat, idents=c("19","18"), invert=TRUE)
