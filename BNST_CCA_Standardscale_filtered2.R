output <- "Seurat/BNST_IndependentAnalysis/BNST_Fullmerge_Test_CCAtestallstandardscale_filtered2"
...
BNST.comb <- readRDS("Seurat/BNST_IndependentAnalysis/BNST_Fullmerge_Test_CCAtestallstandardscale_filtered1CCAscaledata.rds")
BNST.comb <- subset(BNST.comb, idents=c("35","43"), invert=TRUE) 
