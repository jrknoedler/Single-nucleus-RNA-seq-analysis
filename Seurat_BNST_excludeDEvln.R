...
output <- "Seurat/POABNST_DEExclusionClusterTests/BNST_DEexcluded/vln/"
...
mySeurat <- readRDS("Seurat/BNST_POA_PrimedvUnprimedClusterTests/BNST_PrimedvUnprimed_excludeDE.rds")
