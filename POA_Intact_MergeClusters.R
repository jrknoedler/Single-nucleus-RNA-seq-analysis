...
output <- "Seurat/POA_IndependentAnalysis/POA_Intact_Curated_30PCs"
...
mySeurat <- readRDS("Seurat/POA_IndependentAnalysis/POA_IndependentFiltered6_30pcsredo_res1_Intact.rds")
...
VlnPlot(mySeurat, features=c("Esr1", "Slc17a6","Slc32a1"), pt.size=0, ncol=1)
dev.off()
pdf(file=paste0(output,"_Vln_Markers1.pdf"), width=14, height=80)
VlnPlot(mySeurat, features=c("Svil","Tgfbi","Fam20a","Gldc","Chat","Folh1","Plod2","Zeb2","Nr2f1","Smoc2","Lix1","Tcf7l2","Sim1","Skor2","Crym","Thbs4","Gbx1","Elf4","Moxd1","Opn5"), pt.size=0, ncol=1)
dev.off()
