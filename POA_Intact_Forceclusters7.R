...
output <- "Seurat/POA_IndependentAnalysis/POA_IndependentFiltered6_30pcsredo_res1"
...
Intact <- readRDS("Seurat/POA_IndependentAnalysis/POA_IndependentFiltered5_30pcs_res1_Intact.rds")
Intact <- subset(Intact, idents=c("19","22","27"), invert=TRUE)
