...
output <- "Seurat/BNST_IndependentAnalysis/BNST_Intact_Curated_40pcs_NSForestanalysis_Revised2"
...
VlnPlot(mySeurat, features=c("Esr1", "Slc17a6","Slc32a1","Cyp19a1","Rfx3","Kmt2a"), pt.size=0, ncol=1)
dev.off()
