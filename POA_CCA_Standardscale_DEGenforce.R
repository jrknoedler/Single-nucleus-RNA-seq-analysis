output <- "Seurat/POA_IndependentAnalysis/POA_Fullmerge_Test_CCAtestallstandardscale_DEGenforced"
...
POA.anchors <- FindIntegrationAnchors(object.list=list, anchor.features = features.final)
...
saveRDS(POA.comb, file=paste0(output,"CCAscaledata.rds"))