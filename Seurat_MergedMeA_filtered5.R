...
output <- "Seurat/MeA_IndependentAnalysis/MeA_MergedFinal2_Filtered5_malatregressreview_UMIfilter_res1.2"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
...
mySeurat <- readRDS("Seurat/MeA_IndependentAnalysis/MeA_MergedFinal2_Filtered4_malatregressreview_UMIfilter_res1.2.rds")
