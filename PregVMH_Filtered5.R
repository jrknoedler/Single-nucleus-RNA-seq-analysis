...
output <- "Seurat/PregVMH_Exploratory/PregVMH_Filtered5"
...
mySeurat <- readRDS("Seurat/PregVMH_Exploratory/PregVMH_Filtered4.rds")
mySeurat <- subset(mySeurat, idents=c("23"), invert=TRUE)
