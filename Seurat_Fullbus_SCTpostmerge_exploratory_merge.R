...
output <- "Seurat/FULLBUS/FullBusNaiveMerge_"
...
Shared.features <- merge(IntactVMH, y=list(PrimedVMH, UnprimedVMH, CastrateVMH, IntactBNST,PrimedBNST,UnprimedBNST,IntactPOA,PrimedPOA,UnprimedPOA,CastratePOA,IntactMeA,PrimedMeA,UnprimedMeA,CastrateMeA), merge.data=TRUE, project="merged")
mySeurat <- SCTransform(mySeurat, vars.to.regress="status")
