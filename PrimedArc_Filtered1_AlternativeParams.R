...
output <- "Seurat/Primed_Arcuate_Exploratory/Primed_Arcuate_Filtered1_alternativeParam"
...
mySeurat <- readRDS("Seurat/Primed_Arcuate_Exploratory/Primed_Arcuate_1stPass_AdjustedParams.rds")
mySeurat <- subset(mySeurat, idents=c("0","1","2","3"), invert=TRUE)
