...
output <- "Seurat/BNST_IndependentAnalysis/BNST_Inhibexcitheat_"
...
VlnPlot(mySeurat, features=c("Gad1"), idents=c("14"), pt.size=0, cols=c("gray"))
dev.off()
gad <- VlnPlot(mySeurat, features=c("Gad1"), idents=c("14"), pt.size=0)
gaddat <- gad$data
...
VlnPlot(mySeurat, features=c("Slc17a6"), idents=c("14"), pt.size=0, cols=c("gray"))
dev.off()

glut <- VlnPlot(mySeurat, features=c("Slc17a6"), idents=c("14"), pt.size=0)
glutdat <- glut$data
...
VlnPlot(mySeurat, features=c("Cyp19a1"), idents=c("14"), pt.size=0, cols=c("gray"))
dev.off()
cyp <- VlnPlot(mySeurat, features=c("Cyp19a1"), idents=c("14"), pt.size=0)
cypdat <- cyp$data
...
DimPlot(mySeurat, cols=c("0"="red", "1"="red", "2"="red", "3"="red", "4"="red", "5"="red", "6"="blue", "7"="red", "8"="red", "9"="red", "10"="red", "11"="red", "12"="red", "13"="red", "14"="red", "15"="red", "16"="red", "17"="blue", "18"="red", "19"="red", "20"="red", "21"="red", "22"="blue", "23"="red", "24"="red", "25"="red", "26"="red", "27"="red", "28"="red", "29"="red", "30"="red", "31"="red", "32"="red", "33"="red", "34"="blue"), label=FALSE, reduction="umap")
dev.off() 
...
AvgAllDEGs
write.csv(AvgAllDEGs, file="/scratch/users/knoedler/Heatmaps/Seurat/BNST/AllDEGsavg.txt")
data <- read.csv(file="/scratch/users/knoedler/Heatmaps/Seurat/BNST/AllDEGsavg.txt", header=TRUE, row.names=1)
data <- as.matrix(data)
dim(data)
head(data)
data <- scale(t(data))
...
head(idents)
pdf(file=paste0(output,"_sDEGheatmaptrowclustonly.pdf"), width=30, height=30)
pheatmap(data, cluster_cols=FALSE, border_color=NA, color=viridis(500))
dev.off()
pdf(file=paste0(output,"_sDEGheatmapt.pdf"), width=30, height=30)
