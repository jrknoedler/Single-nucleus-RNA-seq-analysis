...
output <- "Seurat/MeA_IndependentAnalysis/MeA_CelltypesCCAfiltered1Marredo_reordered2"
...
dev.off() 
typemarkers <- read.table("DotPlotMarkerLists/MeAReorganized_Reordered_2.txt")
