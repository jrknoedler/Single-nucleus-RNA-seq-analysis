...
typemarkers <- read.table("mouseneuropeptides.csv")
...
dev.off()
mylevels <- c(4,14,15,16,19,20,26,0,1,2,3,5,6,7,8,9,10,11,12,13,17,18,21,22,23,24,25,27,28,29,30,31,32,33,34)
