...
output <- "Seurat/MeA_IndependentAnalysis/MeA_CelltypesCCAfiltered1Mayredo_reorderedJune"
...
dev.off() 
typemarkers <- read.table("DotPlotMarkerLists/MeAReorganized_Reordered.txt")
...
Pct$data
sink()
mylevels <- c(0,3,8,12,13,14,16,17,20,21,22,28,30,31,32,33,1,2,5,6,7,10,11,15,18,19,23,24,26,27,29,34,4,9,25)
