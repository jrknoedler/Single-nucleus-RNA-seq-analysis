...
output <- "Seurat/VMH_IndependentAnalysis/VMH_CelltypesDraftArcfiltered_regressed_reorderedMay"
...
mySeurat <- readRDS("Seurat/VMH_IndependentAnalysis/VMH_Fullmerge_Test_prepaperreclusterRound2_sexclude_malat1regress_filtered5_20pcsres0.9.rds")
...
typemarkers <- read.table("DotPlotMarkerLists/VMH_Reordered_May.txt")
typemarkers <- unlist(typemarkers)
typemarkers <- as.matrix(typemarkers)
mySeurat <- ScaleData(mySeurat)
mylevels <- c(2,3,5,7,8,9,11,12,14,16,17,18,20,21,22,0,1,4,6,10,13,15,19)
