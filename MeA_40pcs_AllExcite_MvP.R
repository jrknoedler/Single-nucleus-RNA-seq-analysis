...
Primed$sex <- "Primed"
Male$sex <- "Male" 
Primed <- subset(Primed, idents=c("6","9","18","8","11","12","0","1","20","19"))
Male <- subset(Male, idents=c("1","2","16","23","21","9","6","20","19","31","28","27"))
...
write.csv(markers, file="Seurat/MeA_IndependentAnalysis/MeA_AllExcitatory_res1_40pcs_MvP_SDEGsMAST.csv")