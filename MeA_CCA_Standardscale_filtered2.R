output <- "Seurat/MeA_IndependentAnalysis/MeA_Fullmerge_Test_CCAtestallstandardscale_DEGenforce_filtered2"
...
MeA.comb <- readRDS("Seurat/MeA_IndependentAnalysis/MeA_Fullmerge_Test_CCAtestallstandardscale_DEGenforce_filtered1CCAscaledata.rds")
MeA.comb <- subset(MeA.comb, idents=c("9","28"), invert=TRUE)
...
t <- prop.table(table(Idents(MeA.comb), MeA.comb$Hormone), margin=2)
