...
output <- "Seurat/Dulac_Integrated/Dulac_JRK_Integrated_nonneuronalfiltreanchoredres2dim40_IEGexclude"
library(Seurat)
#library(cowplot)
#library(reticulate)
#library(ggplot2)
...
genelist <- read.table("ExcludeIDs_dulac.txt", header=FALSE)
