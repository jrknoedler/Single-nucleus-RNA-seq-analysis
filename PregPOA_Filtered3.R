...
output <- "Seurat/PregPOA_Exploratory/PregPOA_Filtered3"
...
mySeurat <- readRDS("Seurat/PregPOA_Exploratory/PregPOA_Filtered2.rds")
mySeurat <- subset(mySeurat, idents=c("21","22","23"), invert=TRUE)
