...
output <- "Seurat/VMH_Anderson/AndersonFemale_GliaFilt1"
...
mySeurat <- readRDS("Seurat/VMH_Anderson/Anderson_Exploratory_Female_Neuron.rds")
mySeurat <- subset(mySeurat, idents=c("0","16","40","59","67","68","71","74","70","10","22","39","60","70","6","30","41","46","55","63","69","72","8","13","65","48","2","3","7","21","15","26","27","32","36","47","49","54","52","75"), invert=TRUE)
