...
output <- "Seurat/PregBNST_Exploratory/PregBNST_Emptydrops_Filtered4"
...
mySeurat <- readRDS("Seurat/PregBNST_Exploratory/PregBNST_Emptydrops_Filtered3.rds")
mySeurat <- subset(mySeurat, idents=c("10","16"), invert=TRUE)
