...
output <- "Seurat/VMH_IndependentAnalysis/VMH_IndependentFiltered1_Primed_30pcs_res1"
...
Primed <- readRDS("Seurat/VMH_IndependentAnalysis/VMH_IndependentFiltered1__Primed.rds")
