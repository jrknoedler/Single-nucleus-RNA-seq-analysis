...
output <- "Seurat/VMH_IndependentAnalysis/VMH_Figs7_"
...
unlist(genes.10x)
typemarkers <- read.csv("Genelists/VMH_revisedPepMarkers.txt")
...
pdf(file=paste0(output,"_filtereddotplot_scaledatabluered.pdf"), width=10)
data %>% 
