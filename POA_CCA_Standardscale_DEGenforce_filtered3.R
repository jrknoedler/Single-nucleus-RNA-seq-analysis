output <- "Seurat/POA_IndependentAnalysis/POA_Fullmerge_Test_CCAtestallstandardscaleDEGenforced_filtered3"
...
POA.comb <- readRDS("Seurat/POA_IndependentAnalysis/POA_Fullmerge_Test_CCAtestallstandardscaleDEGenforced_filtered2CCAscaledata_DEGsonly.rds")
POA.comb <- subset(POA.comb, idents=c("30","42"), invert=TRUE) 
