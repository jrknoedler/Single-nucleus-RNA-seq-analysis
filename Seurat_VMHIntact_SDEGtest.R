#!/usr/bin/env Rscript
output <- "Seurat/VMH_IndependentAnalysis/IntactSDEG_20PCS_Plottest"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
...
mySeurat <- readRDS("Seurat/VMH_IndependentAnalysis/VMH_IndependentFiltered1_20pcs_Intact.rds")
head(mySeurat[[]])
mySeurat
