...
output <- "Seurat/Sakura_IntegrationTests/Naive_Integration_Fixed/POA/IntegratedPOA_Naive_Filtered1"
...
mySeurat <- readRDS("Seurat/Sakura_IntegrationTests/Naive_Integration_Fixed/POA/POA_Naive_Integration_PC30_Res12_Fixed.rds")
mySeurat <- subset(mySeurat, idents=c("40"), invert=TRUE)
