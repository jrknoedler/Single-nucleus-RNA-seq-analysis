...
output <- "Seurat/MeA_IndependentAnalysis/MeA_MergedFinal2_Esr1filtered_malatregressreview_UMIfilter_res1"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
...
mySeurat <- readRDS("Seurat/MeA_IndependentAnalysis/MeA_MergedFinal2_Filtered7_malatregressreview_UMIfilter_res1.2.rds")
mySeurat <- subset(mySeurat, idents=c("4","31","36","37"), invert=TRUE)
