output <- "Seurat/POA_IndependentAnalysis/POA_Fullmerge_Test_CCAtestallstandardscale_filtered2"
...
POA.comb <- readRDS("Seurat/POA_IndependentAnalysis/POA_Fullmerge_Test_CCAtestallstandardscale_filtered1CCAscaledata_DEGsonly.rds")
POA.comb <- subset(POA.comb, idents=c("39","32"), invert=TRUE) 
