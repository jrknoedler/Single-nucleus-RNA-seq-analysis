...
output <- "Seurat/BNST_IndependentAnalysis/BNST_Fullmerge_Test_prepaperreclusterRound4_sexclude_malat1exclude_malat1regress_filtered1"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
...
mySeurat <- subset(mySeurat, idents=c("42","44","39","43"), invert=TRUE)
