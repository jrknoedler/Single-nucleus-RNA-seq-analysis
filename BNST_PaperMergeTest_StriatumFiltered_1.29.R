...
output <- "Seurat/BNST_IndependentAnalysis/BNST_Fullmerge_Test_Striatumfiltered_res1_sexclude_malat1regress_30pcsres1"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
...
mySeurat <- subset(mySeurat, idents=c("27","39"), invert=TRUE)
