...
output <- "Seurat/VMH_Anderson/AndersonFemale_GliaFilt6"
...
mySeurat <- readRDS("Seurat/VMH_Anderson/AndersonFemale_GliaFilt5.rds")
mySeurat <- subset(mySeurat, idents=c("30","38","22"), invert=TRUE)
