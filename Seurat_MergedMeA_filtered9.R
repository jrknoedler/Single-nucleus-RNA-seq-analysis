...
output <- "Seurat/MeA_IndependentAnalysis/MeA_MergedFinal2_Esr1filtered_malatregressreview_UMIfilterfinal_res1.2"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
...
mySeurat <- readRDS("Seurat/MeA_IndependentAnalysis/MeA_MergedFinal2_Esr1filtered_malatregressreview_UMIfilter_res1.2.rds")
