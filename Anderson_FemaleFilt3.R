...
output <- "Seurat/VMH_Anderson/AndersonFemale_GliaFilt3"
...
mySeurat <- readRDS("Seurat/VMH_Anderson/AndersonFemale_GliaFilt2.rds")
mySeurat <- subset(mySeurat, idents=c("0","14","17","24","27","32","36","57"), invert=TRUE)
...
IEGs <- read.table("/home/groups/nirao/Bioinformatics3/Bioinformatics/IEGs.txt", header=FALSE)
IEGs <- unlist(IEGs)
genelist
