...
output <- "Seurat/POA_IndependentAnalysis/POA_Unprimed_Curated_30PCs"
...
mySeurat <- readRDS("Seurat/POA_IndependentAnalysis/POA_IndependentFiltered2_30pcs_Unprimed_res1_Unprimed.rds")
...
VlnPlot(mySeurat, features=c("Svil","Tgfbi","Fam20a","Gldc","Chat","Folh1","Plod2","Zeb2","Nr2f1","Smoc2","Lix1","Tcf7l2","Sim1","Skor2","Ppfibp2","Crym","Thbs4","Gbx1","Elf4","Moxd1","Opn5"), pt.size=0, ncol=1)
dev.off()
