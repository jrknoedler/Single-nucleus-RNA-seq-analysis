...
output <- "Seurat/PregBNST_Exploratory/PregBNST_Emptydrops_Filtered6"
...
mySeurat <- readRDS("Seurat/PregBNST_Exploratory/PregBNST_Emptydrops_Filtered5.rds")
mySeurat <- subset(mySeurat, idents=c("21"), invert=TRUE)
