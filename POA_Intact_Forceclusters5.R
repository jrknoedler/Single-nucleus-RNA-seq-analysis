...
output <- "Seurat/POA_IndependentAnalysis/POA_IndependentFiltered1_30pcs_filtered4_res1"
...
Intact <- readRDS("Seurat/POA_IndependentAnalysis/POA_IndependentFiltered1_15pcs_filtered3_res1_Intact.rds")
Intact <- subset(Intact, idents=c("25","15"), invert=TRUE)
