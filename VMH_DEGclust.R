...
output <- "Seurat/VMH_IndependentAnalysis/VMHMerged_arcfinalfilter_sexclude_malat1regress_res1.2FINAL_DEGclust"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
...
mySeurat <- RunPCA(mySeurat, features=DEGs.filtered)
warnings()
