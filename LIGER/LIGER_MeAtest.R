...
output <- "LIGERoutput/MeA/MeA_Liger_mk1"
library(liger)
library(Seurat)
library(SeuratData)
...
Primed <- readRDS("Seurat/MeA_IndependentAnalysis/MeA_IndependentFiltered2_Primed_30pcs_Res1.5_Intact.rds")
Primed <- RenameCells(Primed, add.cell.id="Primed")
Male <- readRDS("Seurat/MeA_IndependentAnalysis/MeA_IndependentFiltered3_Intact_30pcs_1.5res_Intact.rds")
Male <- RenameCells(Male, add.cell.id="Male")
Unprimed <- readRDS("Seurat/UnprimedMeA_Exploratory/UnprimedMeA_1000cutoff_filtered6_40pcs.rds")
