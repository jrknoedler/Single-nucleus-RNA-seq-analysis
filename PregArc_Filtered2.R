...
output <- "Seurat/PregArc_Exploratory/PregArc_Filtered2"
...
mySeurat <- readRDS("Seurat/PregArc_Exploratory/PregArc_Filtered1.rds")
mySeurat <- subset(mySeurat, idents=c("1","11"), invert=TRUE)
