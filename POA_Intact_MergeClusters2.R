...
output <- "Seurat/POA_IndependentAnalysis/POA_Intact_Curated_Filtered7_30PCs"
...
#Moxd1.use <- WhichCells(mySeurat, idents=c("3"))
...
dev.off()
pdf(file=paste0(output,"_Esr1Vln.pdf"), width=14, height=16)
VlnPlot(mySeurat, features=c("Esr2","Esr1", "Slc17a6","Slc32a1","Klhl13"), pt.size=0, ncol=1)
dev.off()
...
VlnPlot(mySeurat, features=c("Abtb2","Exph5","Sytl4","Th","Bmp3","Slc18a2","Esr2","Fbn2","Svil","Tgfbi","Fam20a","Gldc","Chat","Folh1","Plod2","Zeb2","Nr2f1","Smoc2","Lix1","Tcf7l2","Sim1","Skor2","Crym","Thbs4","Gbx1","Elf4","Moxd1","Opn5"), pt.size=0, ncol=1)
dev.off()
