...
data <- readRDS("Scrattch_hicat/BNST/BNSTMerged_scrattch_hicat_MayBNSTMatrix.rds")
dim(data)
de.param <- de_param(padj.th = 0.05, lfc.th=0.6, low.th=1, q1.th=0.3, q2.th=NULL, q.diff.th=0.1, de.score.th=150, min.cells=100)
data <- cpm(data)
