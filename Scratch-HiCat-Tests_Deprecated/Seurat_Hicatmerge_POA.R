...
output <- "Seurat/POA_IndependentAnalysis/POA_Merged_Clusterfuck_0.1CPM_hicat"
library(liger)
library(Seurat)
library(SeuratData)
...
Scratch.clusters <- read.csv("Seurat/POA_IndependentAnalysis/POAcl.csv", header=TRUE)
