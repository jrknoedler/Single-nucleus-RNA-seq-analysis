...
output <- "Scrattch_hicat/VMH/VMHMerged_filtered1_Paperanalysis_splitter_eigen"
...
saveRDS(norm.data, file=paste0(output,"VMH_SparseMat.rds"))
...
onestep.result <- onestep_clust(norm.data, max.dim=30, dim.method="pca", de.param=strict.param, rm.eigen=rm.eigen)
