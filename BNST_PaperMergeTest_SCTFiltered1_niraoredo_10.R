...
output <- "Seurat/BNST_IndependentAnalysis/BNST_Fullmerge_Test_SCTFiltered1_20pcs_0.8_niraoredo"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
library(dplyr)
mySeurat <- readRDS("Seurat/BNST_IndependentAnalysis/BNST_Fullmerge_Test_SCT20pcsres0.8redo.rds")
