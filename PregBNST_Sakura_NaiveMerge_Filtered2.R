...
output <- "Seurat/Sakura_IntegrationTests/Naive_Integration_Fixed/BNST/IntegratedBNST_Naive_Filtered2"
...
mySeurat <- readRDS("Seurat/Sakura_IntegrationTests/Naive_Integration_Fixed/BNST/IntegratedBNST_Naive_Filtered1.rds")
mySeurat <- subset(mySeurat, idents=c("19"), invert=TRUE)
