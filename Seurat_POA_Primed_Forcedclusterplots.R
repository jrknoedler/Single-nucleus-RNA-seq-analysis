output <- "Seurat/POA_IndependentAnalysis/POA_IndependentFiltered1_15pcs_res1_Primed_plots_"
...
Intact <- readRDS("Seurat/POA_IndependentAnalysis/POA_IndependentFiltered1_15pcs_filtered1_Primed_res1_Intact.rds")
Intact
DefaultAssay <- "RNA"
