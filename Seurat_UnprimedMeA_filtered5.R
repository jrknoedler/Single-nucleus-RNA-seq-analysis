...
output <- "Seurat/UnprimedMeA_Exploratory/UnprimedMeA_1000cutoff_filtered5_40pcs"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
...
mySeurat <- readRDS("Seurat/UnprimedMeA_Exploratory/UnprimedMeA_1000cutoff_filtered4.rds")
