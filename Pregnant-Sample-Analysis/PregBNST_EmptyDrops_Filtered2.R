...
output <- "Seurat/PregBNST_Exploratory/PregBNST_Emptydrops_Filtered2"
...
mySeurat <- readRDS("Seurat/PregBNST_Exploratory/PregBNST_Emptydrops_Filtered1.rds")
mySeurat <- subset(mySeurat, idents=c("6","7","15","21"), invert=TRUE)
