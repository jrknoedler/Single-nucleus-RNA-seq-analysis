...
output <- "Seurat/PregBNST_Exploratory/PregnantBNST_emptyDrops_500lower.001FDR_50000iter"
...
mtx.data <- read_count_output("Preg_KB_Out/Preg_BNST_UpdatedRef2/output_mtx_em/", name="output", tcc=FALSE)
head(mtx.data)
set.seed(100)
e.out <- emptyDrops(mtx.data, lower=500, niter=50000)
e.out
