...
output <- "Seurat/PregBNST_Exploratory/PregBNST_Emptydrops_Filtered3"
...
mySeurat <- readRDS("Seurat/PregBNST_Exploratory/PregBNST_Emptydrops_Filtered2.rds")
mySeurat <- subset(mySeurat, idents=c("2","22"), invert=TRUE)
