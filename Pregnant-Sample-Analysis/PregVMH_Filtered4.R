...
output <- "Seurat/PregVMH_Exploratory/PregVMH_Filtered4"
...
mySeurat <- readRDS("Seurat/PregVMH_Exploratory/PregVMH_Filtered3.rds")
mySeurat <- subset(mySeurat, idents=c("24","28"), invert=TRUE)
