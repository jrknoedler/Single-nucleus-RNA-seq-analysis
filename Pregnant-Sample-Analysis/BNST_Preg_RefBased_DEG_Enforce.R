...
output <- "/scratch/users/knoedler/Seurat/BNST_Preg_RefBased"

##Load dataset 1
Published <- readRDS("/scratch/groups/nirao/shared1/BNST_Published.rds")
...
DEGs1 <- read.csv("/scratch/groups/nirao/shared1/BNST_AllvFemale1.5_3.txt", header = FALSE)
