...
output <- "Seurat/PregVMH_Exploratory/PregVMH_Filtered2"
...
mySeurat <- readRDS("Seurat/PregVMH_Exploratory/PregVMH_Filtered1.rds")
mySeurat <- subset(mySeurat, idents=c("5","34","6"), invert=TRUE)
