...
output <- "Seurat/PregBNST_Exploratory/PregBNST_Emptydrops_Filtered9"
...
mySeurat <- readRDS("Seurat/PregBNST_Exploratory/PregBNST_Emptydrops_Filtered8.rds")
mySeurat <- subset(mySeurat, idents=c("15","29"), invert=TRUE)
