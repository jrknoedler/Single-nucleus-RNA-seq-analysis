...
output <- "Seurat/POA_PregIntegrated/POA_PregFiltered_NaiveMergeTest1"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
...
PregPOA <- readRDS("Seurat/PregPOA_Exploratory/PregPOA_Filtered3.rds")
PregPOA$sex <- "Female"
PregPOA$Hormone <- "Pregnant"
PregPOA[["percent.Malat1"]] <- PercentageFeatureSet(PregPOA, pattern = "Malat1")
