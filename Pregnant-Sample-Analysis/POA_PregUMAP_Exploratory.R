...
library(patchwork)
library(scales)
output <- "X:/Seurat/POA_IndependentAnalysis/POA_Merged_PregDEGProject"
memory.limit(64000)
...
PregvMale <- read.table("X:/Genelists/PregnancyDEGs/POA_PregvMale_All1.5.txt")
PregvEst <- read.table("X:/Genelists/PregnancyDEGs/POA_PregvFr_All1.5.txt")
PregvDiest <- read.table("X:/Genelists/PregnancyDEGs/POA_PregvFnr_All1.5.txt")
unlist(PregvEst)
unlist(PregvMale)
unlist(PregvDiest)
...
Up_DiestvPreg <- read.table("X:Genelists/PregnancyDEGs/POA_PregvFnr_DownPreg.txt", header=FALSE)
