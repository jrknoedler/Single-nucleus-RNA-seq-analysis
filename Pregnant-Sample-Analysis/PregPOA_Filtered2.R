...
output <- "Seurat/PregPOA_Exploratory/PregPOA_Filtered2"
...
mySeurat <- readRDS("Seurat/PregPOA_Exploratory/PregPOA_Filtered1.rds")
mySeurat <- subset(mySeurat, idents=c("2","19","22","28"), invert=TRUE)
