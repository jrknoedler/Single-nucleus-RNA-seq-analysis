...
output <- "Seurat/PregVMH_Exploratory/PregVMH_Filtered6"
...
mySeurat <- readRDS("Seurat/PregVMH_Exploratory/PregVMH_Filtered5.rds")
mySeurat <- subset(mySeurat, idents=c("25"), invert=TRUE)
