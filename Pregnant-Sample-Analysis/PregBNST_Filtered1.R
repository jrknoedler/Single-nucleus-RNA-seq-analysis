...
output <- "Seurat/PregBNST_Exploratory/PregBNST_Filtered2"
...
mySeurat <- readRDS("Seurat/PregBNST_Exploratory/PregBNST_1stPass.rds")
mySeurat <- subset(mySeurat, idents=c("0","6","8","23","24","25"), invert=TRUE)
