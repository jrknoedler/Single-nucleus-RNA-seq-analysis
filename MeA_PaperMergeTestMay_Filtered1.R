...
output <- "Seurat/MeA_IndependentAnalysis/MeA_JuneMerge_filtered1"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
library(dplyr)
mySeurat <- readRDS("Seurat/MeA_IndependentAnalysis/MeA_Fullmerge_Junetest.rds")
mySeurat <- subset(mySeurat, idents=c("0","1"), invert=TRUE)
