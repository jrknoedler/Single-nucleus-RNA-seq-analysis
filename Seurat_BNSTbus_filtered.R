...
output <- "Seurat/BNST_BusMergeTest/BNST_BusMergeTest_nocastrate_filtered1"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
...
mySeurat <- readRDS("Seurat/BNST_BusMergeTest/BNST_BusMergeTest_nocastrate.rds")
mySeurat <- subset(mySeurat, idents=c("3","46","44"), invert=TRUE)
