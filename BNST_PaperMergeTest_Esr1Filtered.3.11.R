...
output <- "Seurat/BNST_IndependentAnalysis/BNST_Fullmerge_Test_Esr1filtered_striatumlightermmalatexcludefiltered_sexclude_malat1regress_40pcsres1.2"
library(Seurat)
library(cowplot)
library(reticulate)
library(ggplot2)
library(dplyr)
mySeurat <- readRDS("Seurat/BNST_IndependentAnalysis/BNST_Fullmerge_Test_Esr1filtered_sexclude_malat1regress_30pcsres1.2.rds")
mySeurat <- subset(mySeurat, idents=c("32","33"), invert=TRUE)
...
mySeurat <- RunUMAP(mySeurat, reduction="pca", dim=1:40)
mySeurat <- FindNeighbors(mySeurat, reduction ="pca", dims=1:40)
