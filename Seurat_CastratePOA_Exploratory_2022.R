...
output <- "Seurat/CastratePOA_Exploratory/CastratePOA_NewAnalysis"
...
library(ggplot2)
library(dplyr)
Seurat.data <- read_count_output("Kallisto_Bus_Output/CastratePOA/combined_counts/", name="output", tcc=FALSE)
