...
output <- "Seurat/BNST_Barcode_Transfer/BNST_Barcode_Lift_Filtered1"
...
mySeurat <- readRDS("Seurat/BNST_Barcode_Transfer/BNST_Barcode_Lift.rds")
DefaultAssay(mySeurat) <- "SCT"
mySeurat <- subset(mySeurat, idents=c("5"), invert=TRUE)
