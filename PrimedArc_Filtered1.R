...
output <- "Seurat/Primed_Arcuate_Exploratory/Primed_Arcuate_Filtered1"
...
mySeurat <- readRDS("Seurat/Primed_Arcuate_Exploratory/Primed_Arcuate_1stPass.rds")
mySeurat <- subset(mySeurat, idents=c("0","1","2","6"), invert=TRUE)
